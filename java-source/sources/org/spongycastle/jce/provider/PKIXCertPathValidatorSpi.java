        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    C53937Olt c53937Olt = c53555OfP2.A0A ? new C53937Olt(this.A00) : null;
                    int iA0G = AbstractC81773lg.A0G(certificates);
                    int iA03 = size;
                    X509Certificate x509Certificate = null;
                    while (iA0G >= 0) {
                        int i2 = size - iA0G;
                        x509Certificate = (X509Certificate) certificates.get(iA0G);
                        boolean zA1X = AbstractC466225p.A1X(iA0G, AbstractC81773lg.A0G(certificates));
                        try {
                            A00(x509Certificate);
                            O94.A0A(cAPublicKey, certPath, trustedCert, date, c54408OvsA03, c53937Olt, c53555OfP2, iA0G, zA1X);
                            boolean z = this.A01;
                            O94.A0I(certPath, c51829NnD, iA0G, z);
                            c53556OfQ = O94.A08(certPath, O94.A07(certPath, hashSetA1D4, c53556OfQ, arrayListArr, iA0G, iA02, z), iA0G);
                            if (iA00 <= 0 && c53556OfQ == null) {
                                throw C54018OnV.A00("No valid policy tree found when one expected.", null, certPath, iA0G);
                            }
                            if (i2 != size) {
                                if (x509Certificate == null || x509Certificate.getVersion() != 1) {
                                    O94.A0C(certPath, iA0G);
                                    c53556OfQ = O94.A09(certPath, c53556OfQ, arrayListArr, iA0G, iA01);
                                    O94.A0H(certPath, c51829NnD, iA0G);
                                    int iA0E = MJr.A0E(certPath, iA0G, iA00);
                                    int iA0E2 = MJr.A0E(certPath, iA0G, iA01);
                                    int iA0E3 = MJr.A0E(certPath, iA0G, iA02);
                                    iA00 = O94.A00(certPath, iA0G, iA0E);
                                    iA01 = O94.A01(certPath, iA0G, iA0E2);
                                    iA02 = O94.A02(certPath, iA0G, iA0E3);
                                    O94.A0D(certPath, iA0G);
                                    if (!MJq.A1W(MJp.A15(certPath, iA0G))) {
                                        if (iA03 <= 0) {
                                            throw C54018OnV.A00("Max path length not greater than zero", null, certPath, iA0G);
                                        }
                                        iA03--;
                                    }
                                    iA03 = O94.A03(certPath, iA0G, iA03);
                                    O94.A0E(certPath, iA0G);
                                    ...
                                    O94.A0F(certPath, certPathCheckers, hashSetA1D2, iA0G);
                                    c54408OvsA03 = O3M.A02(x509Certificate);
                                    try {
                                        cAPublicKey = O8W.A00(certPath.getCertificates(), this.A00, iA0G);
                                        O8W.A08(cAPublicKey);
                                        trustedCert = x509Certificate;
                                    } catch (CertPathValidatorException e) {
                                        throw new CertPathValidatorException("Next working key could not be retrieved.", e, certPath, iA0G);
                                    }
                                } else if (i2 != 1 || !x509Certificate.equals(trustAnchorA01.getTrustedCert())) {
                                    throw new CertPathValidatorException("Version 1 certificates can't be used as CA ones.", null, certPath, iA0G);
                                }
                            }
                            iA0G--;
                        } catch (C50481NAx e2) {
                            throw new CertPathValidatorException(e2.getMessage(), e2._underlyingException, certPath, iA0G);
                        }
                    }
                    Class cls = O94.A00;
                    ...
                    O94.A0G(certPath, certPathCheckers, hashSetA1D, i3);
                    ...
                    throw new CertPathValidatorException("Path processing failed on policy.", null, certPath, iA0G);
