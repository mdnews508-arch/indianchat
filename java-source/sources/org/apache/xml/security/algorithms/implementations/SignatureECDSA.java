...
public abstract class SignatureECDSA extends SignatureAlgorithmSpi {
    ...
    public static byte[] c(byte[] bArr) throws IOException {
        ...
        if (length < 48) {
            throw AbstractC81763lf.A0j("Invalid XMLDSIG format of ECDSA signature");
        }
        int i = length / 2;
        int i2 = i;
    ...
    static {
        Class clsA = a("org.apache.xml.security.algorithms.implementations.SignatureECDSA");
        b = clsA;
    ...
    public boolean b(byte[] bArr) throws XMLSignatureException {
        try {
            ...
            if (a.isDebugEnabled()) {
                ...
                stringBufferA0n.append("Called ECDSA.verify() on ");
                log.debug(MJn.A0l(Base64.b(bArr), stringBufferA0n));
            }
            return this.d.verify(bArrC);
        } catch (IOException e) {
    ...
    public SignatureECDSA() throws XMLSignatureException {
        this.d = null;
        String strA = JCEMapper.a("http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha1");
        if (a.isDebugEnabled()) {
            a.debug(MJp.A0y("Created SignatureECDSA using ", strA, MJm.A0n()));
        }
