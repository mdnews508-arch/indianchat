...
public final class MediaDescriptionCompat implements Parcelable {
    public static final Parcelable.Creator CREATOR = new C46904LAo(1);
    ...
    public static MediaDescriptionCompat A00(Object obj) {
        ...
        if (extras != null) {
            extras.setClassLoader(K7Q.class.getClassLoader());
            try {
                extras.isEmpty();
        ...
        if (extras != null) {
            ...
            MediaDescriptionCompat mediaDescriptionCompat = new MediaDescriptionCompat(iconBitmap, iconUri, mediaUri, bundle, title, subtitle, description, mediaId);
        ...
        MediaDescriptionCompat mediaDescriptionCompat2 = new MediaDescriptionCompat(iconBitmap, iconUri, mediaUri, bundle, title, subtitle, description, mediaId);
    ...
    public void writeToParcel(Parcel parcel, int i) {
        MediaDescription mediaDescriptionBuild = this.A00;
        if (mediaDescriptionBuild == null) {
            ...
            this.A00 = mediaDescriptionBuild;
        }
    ...
    public String toString() {
        ...
        sbA08.append((Object) this.A07);
        sbA08.append(", ");
        sbA08.append((Object) this.A06);
        sbA08.append(", ");
