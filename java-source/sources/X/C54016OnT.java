...
public class C54016OnT extends CertPathBuilderSpi {
    ...
    public /* bridge */ /* synthetic */ CertPathChecker engineGetRevocationChecker() {
        return new C54021Ona(this.A01);
    }

    public C54016OnT(boolean z) {
        this.A01 = new C53943Olz();
        this.A02 = z;
    }
        ...
        if (!list.contains(x509Certificate) && !c53554OfO.A01.contains(x509Certificate) && ((i = c53554OfO.A00) == -1 || AbstractC81773lg.A0G(list) <= i)) {
            ...
            try {
                try {
                    ...
                    C54019OnX c54019OnX = new C54019OnX(this.A02);
                    ...
                    if (z) {
                        try {
                            ...
                            try {
                                PKIXCertPathValidatorResult pKIXCertPathValidatorResult = (PKIXCertPathValidatorResult) c54019OnX.engineValidate(certPathEngineGenerateCertPath, c53554OfO);
