...
/* JADX INFO: renamed from: X.4RA, reason: invalid class name */
/* JADX INFO: loaded from: classes4.dex */
public final class C4RA extends C0K3<String, AgeVerificationBloksFetcher> {
    @Override // X.C0K3
    public java.util.Map A00() {
        Set setA0z = AbstractC81763lf.A0z(7686);
        LinkedHashMap linkedHashMapA14 = AbstractC466425r.A14(AbstractC002201c.A00(setA0z));
        Iterator it = setA0z.iterator();
        while (it.hasNext()) {
            it.next();
            linkedHashMapA14.put("DI_KEY_AGE_VERIFICATION_BLOKS_FETCHER", C00S.A03(49321));
        }
