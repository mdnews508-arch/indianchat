...
public final class C49858MtW extends AbstractC52699OBb {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof C49858MtW) {
                C49858MtW c49858MtW = (C49858MtW) obj;
                if (this.A01 != c49858MtW.A01 || this.A00 != c49858MtW.A00 || !C000700h.areEqual(this.A02, c49858MtW.A02) || !C000700h.areEqual(this.A03, c49858MtW.A03)) {
                }
            }
            return false;
        }
    ...
    public String toString() {
        ...
        AbstractC52699OBb.A00(num, "AdHubCentralEntryParams(entryPointSource=", sbA08, i);
        sbA08.append(", userFlowUuid=");
        sbA08.append(str);
        return AbstractC32971bt.A0S(", websiteUrl=", str2, sbA08);
    }

    public C49858MtW(Integer num, String str, String str2, int i) {
