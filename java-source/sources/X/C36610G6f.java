...
/* JADX INFO: renamed from: X.G6f, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes8.dex */
public final class C36610G6f implements InterfaceC146656cL {
    ...
    public final C05C A03 = AnonymousClass056.A00(115162);
    ...
    public void BBx(C0OF c0of, C0I0 c0i0, int i) {
        ...
        G4U g4u = new G4U(c0i0, this, num, numA00, 2);
    ...
    @Override // X.InterfaceC146656cL
    public String Ajw() {
        return "WamoDeferredDATosActivityResultHandler.KEY";
    }

    public static final void A00(C0I0 c0i0, C36610G6f c36610G6f, Integer num) {
        if (num.intValue() != 0) {
            AbstractC31900DxP.A0t(c36610G6f.A01, c0i0);
            return;
        }
        C35246FgT c35246FgT = (C35246FgT) c0i0.getIntent().getParcelableExtra("status_call_state");
        if (c35246FgT != null) {
            ((C27181Gg) C05C.A02(c36610G6f.A02)).C2k(c35246FgT, c0i0);
        }
    }
}
