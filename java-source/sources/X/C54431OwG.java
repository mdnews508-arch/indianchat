...
public class C54431OwG extends C1TZ implements P4s {
    ...
    public boolean A0J(C1TZ c1tz) {
        if (c1tz instanceof C54431OwG) {
            return Arrays.equals(this.A00, ((C54431OwG) c1tz).A00);
        }
        return false;
    }
