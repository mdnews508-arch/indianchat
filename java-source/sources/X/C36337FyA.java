...
public final class C36337FyA implements GOA {
    ...
    public /* bridge */ /* synthetic */ String B46(Context context, FY9 fy9) {
        ...
        String strA0s = AbstractC28941Ni.A07(strA00) ? AbstractC466525s.A0s(context, strA00, 1, 0, R.string._name_removed__res_0x7f122833) : context.getString(R.string._name_removed__res_0x7f122834);
        C000700h.A09(strA0s);
        return strA0s;
    }
    ...
    @Override // X.GOA
    public int Aeh() {
        return R.string._name_removed__res_0x7f122824;
    }

    @Override // X.GOA
    public int B2K() {
        return R.string._name_removed__res_0x7f122831;
    }
}
