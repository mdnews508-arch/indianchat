...
/* JADX INFO: renamed from: X.70Z, reason: invalid class name */
/* JADX INFO: loaded from: classes5.dex */
public final class C70Z extends C7i3 {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (C000700h.areEqual(getClass(), AbstractC81803lj.A0k(obj))) {
                ...
                C70Z c70z = (C70Z) obj;
                if (!Arrays.equals(this.A03, c70z.A03) || !Arrays.equals(this.A04, c70z.A04) || !C000700h.areEqual(this.A01, c70z.A01) || !C000700h.areEqual(this.A02, c70z.A02) || !C000700h.areEqual(this.A00, c70z.A00)) {
                }
            }
            return false;
        }
    ...
    public int hashCode() {
        return AbstractC466425r.A03(this.A00, (AbstractC32971bt.A0C(this.A01, ((Arrays.hashCode(this.A03) * 31) + Arrays.hashCode(this.A04)) * 31) + AbstractC81803lj.A0H(this.A02)) * 31);
    }
    ...
    public String toString() {
        ...
        sbA08.append(string);
        sbA08.append(", emojiWithSkinTone=");
    ...
    public C70Z(C176797pz c176797pz, C26151Cc c26151Cc, Integer num, int[] iArr, int[] iArr2) {
        super(c176797pz);
