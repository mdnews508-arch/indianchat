...
/* JADX INFO: renamed from: X.7KR, reason: invalid class name */
/* JADX INFO: loaded from: classes5.dex */
public final class C7KR extends C7KS {
    ...
    public C7KR(View view, InterfaceC001500s interfaceC001500s, C0FJ c0fj, AnonymousClass089 anonymousClass089, C0VH c0vh, C153376pJ c153376pJ, C7UH c7uh, boolean z, boolean z2) {
    ...
    public void A0N(C164487Kc c164487Kc, int i, int i2) {
        C000700h.A0A(c164487Kc, 1);
        String str = c164487Kc.A06;
        Integer num = (str == null || str.length() == 0) ? null : 1;
        InterfaceC199688nj interfaceC199688nj = this.A0D.A0G;
        if (interfaceC199688nj != null) {
            interfaceC199688nj.BQK(Integer.valueOf(i2), num, i);
        }
    }
}
