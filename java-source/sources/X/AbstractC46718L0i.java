...
/* JADX INFO: renamed from: X.L0i, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes10.dex */
public abstract class AbstractC46718L0i {
    public static String A00(int i, int i2, String str) {
        ...
        return AbstractC46042KlE.A01(str2, objArrA1b);
    }
    ...
    public static void A01(int i, int i2) {
        ...
        if (i < 0 || i >= i2) {
            ...
            throw J27.A0a(AbstractC46042KlE.A01(str, objArrA1b));
        }
    }

    public static void A02(int i, int i2) {
        if (i < 0 || i > i2) {
            throw J27.A0a(A00(i, i2, "index"));
        }
    }
    ...
    public static void A03(int i, int i2, int i3) {
        ...
        if (i < 0) {
            ...
            if (i > i3) {
                ...
                strA00 = AbstractC46042KlE.A01("end index (%s) must not be less than start index (%s)", objArrA1a);
            }
        }
