...
/* JADX INFO: renamed from: X.H3s, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes9.dex */
public final class C38759H3s extends C0BP {
    public Boolean A00;
    public Boolean A01;
    public Boolean A02;
    public Boolean A03;
    ...
    public String getEventNameForFalco() {
        return "wam_business_template_rich_order_status";
    }
    ...
    public C38759H3s() {
        super(7076, AbstractC466825v.A0a(), 2, 113760892);
    }
    ...
    public java.util.Map getFieldsMapForFalco() {
        LinkedHashMap linkedHashMapA1E = AbstractC465925m.A1E();
        linkedHashMapA1E.put("action_type_rich_order_status", this.A06);
    ...
    public String toString() {
        ...
        sbA08.append("WamBusinessTemplateRichOrderStatus {");
        C0BR.A00(this.A06, "actionTypeRichOrderStatus", sbA08);
