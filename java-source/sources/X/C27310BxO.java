...
public final class C27310BxO extends AbstractC31091Xd {
    public final C31111Xf A00 = new C31111Xf("e2ee_stanza_queue", "SELECT *\n      FROM e2ee_stanza_queue\n      ORDER BY _id ASC\n      LIMIT ?", "SELECT *\n      FROM e2ee_stanza_queue\n      WHERE _id > ?\n      ORDER BY _id ASC\n      LIMIT ?", "SELECT\n            _id,\n            stanza_key,\n            stanza_class,\n            chat_type,\n            process_count,\n            create_time_ms,\n            sort_id,\n            chat_jid,\n            (stanza_payload IS NULL) AS has_null_payload\n      FROM e2ee_stanza_queue\n      ORDER BY _id", "SELECT MAX(sort_id)\n      FROM e2ee_stanza_queue", "SELECT *\n      FROM e2ee_stanza_queue\n      WHERE sort_id > ?\n      ORDER BY sort_id ASC\n      LIMIT ?");
    ...
    public ArrayList A05(Cursor cursor, List list) {
        ...
        while (cursor.moveToNext()) {
            ...
            if (c08940azA00 == null) {
                ...
                sbA08.append("E2eeQueueStore/readStanzas/payload deserialization failed, skipping/rowId=");
                sbA08.append(j);
                ...
                sbA09.append("rowId=");
                sbA09.append(j);
                c0agA0j.A0g("ccq-E2eeQueue/decode-failure-on-load", AnonymousClass000.A04(enumC35811hm, " stanzaClass=", sbA09), false, 2);
                ...
                Integer numA04 = C0KW.A03(cursor, columnIndexOrThrow9);
                int i = cursor.getInt(columnIndexOrThrow10);
                boolean zA06 = C0KW.A06(cursor, columnIndexOrThrow11);
                boolean zA07 = C0KW.A06(cursor, columnIndexOrThrow12);
                ...
                arrayListA0W.add(new C27307BxL(cgl, c28772CjQ, enumC35811hm, c02710Cl.A02(string2), c02710Cl.A02(string3), c08940azA00, numA04, lValueOf, string, i, i2, j2, j3, j4, zA06, zA07, false, true));
            }
        }
        return arrayListA0W;
    }
    ...
    @Override // X.AbstractC31091Xd
    public int A01() {
        return AbstractC465925m.A00(AbstractC466225p.A0c(this.A01), 22211);
    }

    @Override // X.AbstractC31091Xd
    public /* bridge */ /* synthetic */ ContentValues A02(C1YQ c1yq, ByteArrayOutputStream byteArrayOutputStream) {
        C27307BxL c27307BxL = (C27307BxL) c1yq;
        C000700h.A0A(c27307BxL, 0);
        byte[] bArrA01 = AnonymousClass218.A01(c27307BxL.A0A, byteArrayOutputStream);
        if (bArrA01 == null) {
            AbstractC466325q.A1A(c27307BxL, "E2eeQueueStore/toContentValues/null payload, skipping insert/", AnonymousClass000.A08());
            AbstractC466225p.A0j(this.A03).A0g("ccq-E2eeQueue/null-payload-on-write", AnonymousClass000.A04(c27307BxL.A07, "stanzaClass=", AnonymousClass000.A08()), false, 2);
            return null;
        }
        ContentValues contentValuesA06 = AbstractC466425r.A06();
        contentValuesA06.put("stanza_id", c27307BxL.A0B);
        contentValuesA06.put("stanza_key", c27307BxL.A06.A00);
        contentValuesA06.put("stanza_class", AbstractC148886gA.A0z(c27307BxL.A07));
        CGL cgl = c27307BxL.A05;
        contentValuesA06.put("chat_type", cgl != null ? AbstractC148886gA.A0z(cgl) : null);
        contentValuesA06.put("chat_jid", AbstractC25331B9z.A0y(c27307BxL.A08));
        com.whatsapp.infra.core.jid.Jid jid = c27307BxL.A09;
        contentValuesA06.put("sender_jid", jid != null ? jid.getRawString() : null);
        contentValuesA06.put("stanza_payload", bArrA01);
        contentValuesA06.put("offline_count", c27307BxL.A01);
        contentValuesA06.put("e2ee_retry_count", Integer.valueOf(c27307BxL.A00));
        contentValuesA06.put("has_pkmsg", Boolean.valueOf(c27307BxL.A02));
        BA3.A0E(contentValuesA06, c27307BxL, Boolean.valueOf(c27307BxL.A03), "has_skmsg");
    ...
    public ArrayList A04(Cursor cursor) {
        ...
        while (cursor.moveToNext()) {
            ...
            arrayListA0p.add(new C29132CpH(cgl, CHS.A05, c28772CjQ, enumC35811hm, AbstractC465925m.A0m(string), lValueOf, lA04, i2, 1, j2, z));
        }
        return arrayListA0p;
    }
