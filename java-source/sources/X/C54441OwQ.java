...
public class C54441OwQ extends AbstractC54422Ow7 {
    public int A00 = -1;
    ...
    public void A0G(O2T o2t, boolean z) throws IOException {
        ...
        if (iA0C < 0) {
            if (length <= 16) {
                ...
                for (int i2 = 0; i2 < length; i2++) {
                    C1TZ c1tzA0F = super.A00[i2].CYx().A0F();
                    c1tzArr[i2] = c1tzA0F;
                    iA0D += c1tzA0F.A0D();
                }
                this.A00 = iA0D;
            ...
            iA0C = 0;
            do {
                iA0C = MJq.A0C(super.A00, i3, iA0C);
                i3++;
            } while (i3 < length);
            this.A00 = iA0C;
        }
        o2t.A03(iA0C);
        while (i < length) {
            c54414Ovy.A04(super.A00[i].CYx(), true);
            i++;
        }
    }
}
