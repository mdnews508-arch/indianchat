...
public final class C52294Nvg {
    ...
    public void finalize() {
        if (this.A02 != EGL14.EGL_NO_DISPLAY) {
            android.util.Log.w("Grafika", "WARNING: EglCore was not explicitly released -- state may be leaked");
            A00();
        }
    }

    public C52294Nvg(int i) {
        this.A02 = EGL14.EGL_NO_DISPLAY;
        ...
        if (eGLContextEglCreateContext == EGL14.EGL_NO_CONTEXT) {
            int[] iArr2 = {12324, 8, 12323, 8, 0, 0, 0, 8, 12352, 4, 12344, 0, 12344};
            MJq.A1M(iArr2);
            if ((i & 1) != 0) {
                iArr2[10] = 12610;
                iArr2[11] = 1;
            ...
            if (EGL14.eglChooseConfig(this.A02, iArr2, 0, eGLConfigArr, 0, 1, new int[1], 0)) {
                ...
                sbA08.append(2);
                android.util.Log.w("Grafika", AnonymousClass000.A06(" EGLConfig", sbA08));
            }
        ...
        android.util.Log.d("Grafika", AbstractC202178rm.A1D(sbA010, iArr3[0]));
    }
