...
public final class PFU extends WebChromeClient {
    ...
    public void onProgressChanged(WebView webView, int i) {
        String str;
        String str2;
        if ((webView instanceof SecureWebView) && i >= 20) {
            C222259qC c222259qC = ((SecureWebView) webView).A07;
            if (c222259qC.A02) {
                SecureWebView secureWebView = c222259qC.A03;
                if (secureWebView.getSettings().getJavaScriptEnabled() && (str = c222259qC.A00) != null && !c222259qC.A01) {
                    HashMap map = c222259qC.A04;
                    boolean zContainsKey = map.containsKey(str);
                    String str3 = c222259qC.A00;
                    if (zContainsKey) {
                        C46415Ksd c46415Ksd = (C46415Ksd) map.get(str3);
                        str2 = c46415Ksd != null ? c46415Ksd.A01 : Voip.REJECT_REASON_DECLINED;
                    } else {
                        C46415Ksd c46415Ksd2 = new C46415Ksd(str3);
                        str2 = c46415Ksd2.A01;
                        map.put(c222259qC.A00, c46415Ksd2);
                    }
                    StringBuilder sbA08 = AnonymousClass000.A08();
                    sbA08.append("javascript:var __fbAndroidBridgeAuthToken = '");
                    sbA08.append(str2);
                    secureWebView.A04(AnonymousClass000.A06("';window.dispatchEvent(new Event('__fbAndroidBridgeAuthTokenInjected'));", sbA08));
                    c222259qC.A01 = true;
                }
            }
        }
    ...
    public PFU(C55046PNh c55046PNh) {
        this.A00 = c55046PNh;
    }
}
