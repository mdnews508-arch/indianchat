...
public class C53918OlZ implements PDv {
    ...
    public void ALu(byte[] bArr, int i) {
        int i2 = this.A00;
        if (i2 % 8 != 0) {
            throw AbstractC465925m.A15("attempt to absorb with odd length queue");
        }
        if (this.A03) {
            throw AbstractC465925m.A15("attempt to absorb while squeezing");
        }
        byte[] bArr2 = this.A04;
        ...
        long j = this.A01;
        int i4 = i3 >>> 3;
        MJm.A13(bArr2[i4], bArr2, (byte) (1 << (i3 & 7)), i4);
        int i5 = i3 + 1;
        this.A00 = i5;
        int i6 = 0;
        if (i5 == this.A02) {
        ...
        long j2 = 0;
        if (j % 8 != 0) {
            throw AbstractC465925m.A15("outputLength not a multiple of 8");
        }
        while (j2 < j) {
            if (i6 == 0) {
                A01();
                ...
                for (int i14 = 0; i14 < i12; i14++) {
                    AbstractC33911eL.A05(jArr4[i14], bArr3, i13);
                    i13 += 8;
                }
                this.A00 = i6;
            }
            int iMin = (int) Math.min(i6, j - j2);
            System.arraycopy(this.A04, (this.A02 - i6) / 8, bArr, ((int) (j2 / 8)) + i, iMin / 8);
            i6 = this.A00 - iMin;
            this.A00 = i6;
            j2 += (long) iMin;
        }
    ...
    public static void A02(C53918OlZ c53918OlZ, int i) {
        if (i != 128 && i != 224 && i != 256 && i != 288 && i != 384 && i != 512) {
            throw AbstractC32971bt.A0O("bitLength must be one of 128, 224, 256, 288, 384, or 512.");
        }
        int i2 = 1600 - (i << 1);
        if (i2 <= 0 || i2 >= 1600 || i2 % 64 != 0) {
            throw AbstractC465925m.A15("invalid rate value");
        }
        c53918OlZ.A02 = i2;
        int i3 = 0;
        while (true) {
            long[] jArr = c53918OlZ.A05;
            if (i3 >= 25) {
                Arrays.fill(c53918OlZ.A04, (byte) 0);
                c53918OlZ.A00 = 0;
                c53918OlZ.A03 = false;
                c53918OlZ.A01 = (1600 - i2) / 2;
                return;
            }
            jArr[i3] = 0;
            i3++;
    ...
    private void A03(byte[] bArr, int i) {
        ...
        int i5 = 0;
        do {
            AbstractC33911eL.A05(jArr2[i4], bArr2, i5);
            i5 += 8;
            i4++;
        } while (i4 != 25);
        C1TO.A02(AbstractC52576O3a.A02(bArr2, 0, 200));
        A01();
    }
    ...
    public static long A00(byte[] bArr, int i) {
        return ((((long) AbstractC33911eL.A01(bArr, i + 4)) & GarminVoiceMessageNative.DURATION_MASK) << 32) | (GarminVoiceMessageNative.DURATION_MASK & ((long) AbstractC33911eL.A01(bArr, i)));
    }
