...
public final class C35742FoW implements InterfaceC43121Ixf {
    public View A00;
    public boolean A01;
    ...
    public C35742FoW(View.OnClickListener onClickListener, View.OnClickListener onClickListener2, C40912Hyn c40912Hyn) {
    ...
    public void A00(boolean z) {
        ...
        if (view2.getBottom() <= interfaceC30801Vw.getListView().getHeight()) {
            AbstractC82413mn.A05(view2, RunnableC36715GAm.A00(view, interfaceC30801Vw, 18));
        }
    }

    @Override // X.InterfaceC43121Ixf
    public void BP1(View view, ViewGroup viewGroup, boolean z) {
        LinearLayout linearLayoutA01 = this.A04.A01();
