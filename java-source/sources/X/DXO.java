...
public final class DXO implements InterfaceC12180ga {
    public C1DO A00;
    ...
    public void Bq2(C1DO c1do, int i) {
        C000700h.A0A(c1do, 0);
        if (C000700h.areEqual(this.A01, c1do.A0i.A00)) {
            this.A00 = c1do;
            this.A02.countDown();
        }
    }
    ...
    public DXO(AbstractC02700Ci abstractC02700Ci, CountDownLatch countDownLatch) {
