...
public final class DOY implements InterfaceC31885DxA {
    ...
    public void APP(C1LT c1lt) {
        ...
        try {
            Cursor cursorA0A = c15tA0c.A02.A0A("\n          SELECT \n            old_data \n          FROM \n            message_system_value_change \n          WHERE \n            message_row_id = ?\n        ", "GET_SYSTEM_MESSAGE_VALUE_CHANGE", BA1.A1b(c1q));
            try {
                if (cursorA0A.moveToNext()) {
                    c1q.A01 = C0KW.A05(cursorA0A, "old_data");
                }
                cursorA0A.close();
                c15tA0c.close();
            } catch (Throwable th) {
    ...
    public void BG0(C1LT c1lt) {
        ...
        try {
            BA2.A0a(BA2.A04(c1q), c15tA0R, c1q.A01);
            c15tA0R.close();
        } catch (Throwable th) {
            try {
                throw th;
