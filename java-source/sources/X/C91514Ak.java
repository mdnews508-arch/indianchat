...
public final class C91514Ak extends AbstractC92054Cn {
    public final InterfaceC020009l A00;
    public final int A01 = 3;
    public final List A02;

    public C91514Ak(List list, InterfaceC020009l interfaceC020009l) {
        this.A02 = list;
    ...
    public AbstractC132185tN A0y(C131155rg c131155rg) {
        ...
        try {
            C125025ha c125025haA03 = C131155rg.A03(c131155rg, C142476Pl.A00);
            List list = this.A02;
            int size = list.size();
            int size2 = this.A01;
            int i = size - size2;
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                C117975Pn c117975Pn = (C117975Pn) AbstractC02550Br.A0z(list, i2);
                if (c117975Pn != null) {
                    String str = c117975Pn.A00;
                    arrayListA0W.add(new C91894Bw(c117975Pn.A02, c117975Pn.A01, new C141736Mp(this, str, i2, zA0B ? 1 : 0), AbstractC466225p.A1V(str.length()), zA0B, AbstractC125295i5.A0G(c131155rg, EnumC98504dI.A0U), true));
                }
            }
            if (i > 0 && !C125025ha.A05(c125025haA03)) {
                ...
                arrayListA0W.add(new C91894Bw(AbstractC123865fZ.A02(c131155rg, String.valueOf(i), i3), null, C143146Sa.A01(c125025haA03, 3), true, true, zA0B, true));
            }
