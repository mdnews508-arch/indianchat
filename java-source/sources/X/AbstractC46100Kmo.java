...
public abstract class AbstractC46100Kmo {
    public static final C46438Kt7 A00 = new C46438Kt7("PhoneskyVerificationUtils");
    ...
    public static boolean A00(Signature[] signatureArr) {
        ...
        c46438Kt7.A02(String.format("Play Store package certs are not valid. Found these sha256 certs: [%s].", objArr), new Object[0]);
        return false;
    }
}
