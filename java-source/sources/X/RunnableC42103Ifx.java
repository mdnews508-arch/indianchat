...
public final class RunnableC42103Ifx implements Runnable {
    ...
    public RunnableC42103Ifx(C14290kl c14290kl, InterfaceC43206Iz3 interfaceC43206Iz3, C40914Hyp c40914Hyp, ITQ itq, PublicKey publicKey, X509Certificate x509Certificate, int i) {
    ...
    public void run() {
        ...
        itq.CAp(c14290kl, this.A02, this.A03, Integer.valueOf(this.A00), publicKey, x509Certificate);
    }
}
