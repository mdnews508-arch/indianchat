...
public class C30264DMf implements InterfaceC29371Oz {
    @Override // X.InterfaceC29371Oz
    public boolean BHo(C1DO c1do) {
        String strAmI;
        C000700h.A0A(c1do, 0);
        return (c1do instanceof AnonymousClass788) && (strAmI = ((C1PW) c1do).AmI()) != null && strAmI.length() > 0;
    }
    ...
    @Override // X.InterfaceC29371Oz
    public boolean BN0() {
        return !(this instanceof C27239BwA);
    }
