...
/* JADX INFO: renamed from: X.70M, reason: invalid class name */
/* JADX INFO: loaded from: classes5.dex */
public final class C70M extends AbstractC165817St {
    public final int A00;
    public final int[] A01;

    public C70M(int[] iArr, int i) {
        C000700h.A0A(iArr, 0);
        this.A01 = iArr;
        this.A00 = i;
    }
    ...
    public String toString() {
        ...
        sbA08.append("ShowSkinToneTip(emoji=");
        sbA08.append(string);
