...
/* JADX INFO: renamed from: X.MwB, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes11.dex */
public final class C50014MwB extends C08U {
    public int A00;
    public int A01;
    public int A02;
    public boolean A03;
    ...
    public boolean A0C;
    public boolean A0D;
    public C52265Nv3 A0E;
    public boolean A0F;
    public final WeakReference A0G;
    public final ArrayList A0H;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C50014MwB(WeakReference weakReference) {
    ...
    private final void A00() {
        ...
        this.A0E = new C52265Nv3(weakReference);
        this.A07 = false;
        this.A08 = false;
        GL10 gl10 = null;
        boolean z = false;
        ...
        while (true) {
            try {
                C51384NfI c51384NfI = AbstractTextureViewSurfaceTextureListenerC48676MOq.A0A;
                synchronized (c51384NfI) {
                            ...
                            if (this.A06 && !this.A0C && this.A02 > 0 && this.A01 > 0 && (this.A09 || this.A00 == 1)) {
                                if (!this.A07) {
                                    if (z8) {
                                        ...
                                        C50014MwB c50014MwB = c51384NfI.A00;
                                        try {
                                            if (c50014MwB == this || c50014MwB == null) {
                                                c51384NfI.A00 = this;
                                            } else {
                                                if (!c51384NfI.A02) {
                                                    if (AbstractTextureViewSurfaceTextureListenerC48676MOq.A09 >= 131072) {
                                                        c51384NfI.A03 = true;
                                                    }
                                                    c51384NfI.A02 = true;
                                                }
                                            ...
                                            if (c52265Nv3 != null) {
                                                ...
                                                c52265Nv3.A03 = eGLDisplayEglGetDisplay;
                                                if (eGLDisplayEglGetDisplay == EGL10.EGL_NO_DISPLAY) {
                                                    throw AbstractC81763lf.A0t("eglGetDisplay failed");
                                                }
                                                int[] iArrA1W = AbstractC81763lf.A1W();
                                                EGL10 egl13 = c52265Nv3.A00;
                                                if (egl13 != null && !egl13.eglInitialize(eGLDisplayEglGetDisplay, iArrA1W)) {
                                                    throw AbstractC81763lf.A0t("eglInitialize failed");
                                                }
                                                AbstractTextureViewSurfaceTextureListenerC48676MOq abstractTextureViewSurfaceTextureListenerC48676MOq = (AbstractTextureViewSurfaceTextureListenerC48676MOq) c52265Nv3.A05.get();
                                                if (abstractTextureViewSurfaceTextureListenerC48676MOq == null) {
                                                    c52265Nv3.A01 = null;
                                                    c52265Nv3.A02 = null;
                                                } else {
                                                    try {
                                                        P17 p17 = abstractTextureViewSurfaceTextureListenerC48676MOq.A04;
                                                        if (p17 != null) {
                                                            EGL10 egl14 = c52265Nv3.A00;
                                                            EGLDisplay eGLDisplay = c52265Nv3.A03;
                                                            AbstractC53227OYn abstractC53227OYn = (AbstractC53227OYn) p17;
                                                            if (egl14 != null) {
                                                                int[] iArrA1a = MJm.A1a();
                                                                int[] iArr = abstractC53227OYn.A00;
                                                        ...
                                                        eGLConfig = null;
                                                        c52265Nv3.A01 = eGLConfig;
                                                        C50895NRy c50895NRy = abstractTextureViewSurfaceTextureListenerC48676MOq.A02;
                                                        if (c50895NRy != null) {
                                                            EGL10 egl15 = c52265Nv3.A00;
                                                            EGLDisplay eGLDisplay2 = c52265Nv3.A03;
                                                            int i11 = c50895NRy.A00.A00;
                                                        ...
                                                        c52265Nv3.A02 = eGLContextEglCreateContext;
                                                        ...
                                                        ((C0JT) c52265Nv3.A06.getValue()).CJe(new RunnableC53537Of4(abstractTextureViewSurfaceTextureListenerC48676MOq, 5));
                                                    }
                                                }
                                                c52265Nv3.A02 = null;
                                                EGL10 egl16 = c52265Nv3.A00;
                                                if (egl16 != null) {
                                                    C52265Nv3.A07.A00("createContext", egl16.eglGetError());
                                                    throw null;
                                                }
                                                c52265Nv3.A04 = null;
                                            }
                    ...
                    if (objRemove != null) {
                        ...
                        if (z2) {
                            C52265Nv3 c52265Nv4 = this.A0E;
                            if (c52265Nv4 != null) {
                                if (c52265Nv4.A00 == null) {
                                    throw AbstractC81763lf.A0t("egl not initialized");
                                }
                                if (c52265Nv4.A03 == null) {
                                    throw AbstractC81763lf.A0t("eglDisplay not initialized");
                                }
                                if (c52265Nv4.A01 == null) {
                                    throw AbstractC81763lf.A0t("eglConfig not initialized");
                                }
                                c52265Nv4.A00();
                                AbstractTextureViewSurfaceTextureListenerC48676MOq abstractTextureViewSurfaceTextureListenerC48676MOq2 = (AbstractTextureViewSurfaceTextureListenerC48676MOq) c52265Nv4.A05.get();
                                EGLSurface eGLSurface = null;
                                if (abstractTextureViewSurfaceTextureListenerC48676MOq2 != null && (egl11 = c52265Nv4.A00) != null && abstractTextureViewSurfaceTextureListenerC48676MOq2.A03 != null) {
                                    EGLDisplay eGLDisplay3 = c52265Nv4.A03;
                                    EGLConfig eGLConfig2 = c52265Nv4.A01;
                                    SurfaceTexture surfaceTexture = abstractTextureViewSurfaceTextureListenerC48676MOq2.getSurfaceTexture();
                                ...
                                c52265Nv4.A04 = eGLSurface;
                                if (eGLSurface != null && eGLSurface != EGL10.EGL_NO_SURFACE && ((egl10 = c52265Nv4.A00) == null || egl10.eglMakeCurrent(c52265Nv4.A03, eGLSurface, eGLSurface, c52265Nv4.A02))) {
                                    synchronized (c51384NfI) {
                                        try {
                                            this.A04 = true;
                                            c51384NfI.notifyAll();
                        ...
                        if (z3) {
                            C52265Nv3 c52265Nv5 = this.A0E;
                            if (c52265Nv5 != null) {
                                EGLContext eGLContext2 = c52265Nv5.A02;
                                    ...
                                    if (!c51384NfI.A01) {
                                        ...
                                        if (AbstractTextureViewSurfaceTextureListenerC48676MOq.A09 < 131072) {
                                            if (strGlGetString != null) {
                                                c51384NfI.A03 = !AbstractC81773lg.A1Y("Q3Dimension MSM7500 ", 1, strGlGetString);
                                            }
                                            c51384NfI.notifyAll();
                                        }
                                        c51384NfI.A01 = true;
                        ...
                        if (z) {
                            AbstractTextureViewSurfaceTextureListenerC48676MOq abstractTextureViewSurfaceTextureListenerC48676MOq3 = (AbstractTextureViewSurfaceTextureListenerC48676MOq) weakReference.get();
                            if (abstractTextureViewSurfaceTextureListenerC48676MOq3 != null && (renderer3 = abstractTextureViewSurfaceTextureListenerC48676MOq3.A01) != null) {
                                C52265Nv3 c52265Nv6 = this.A0E;
                                renderer3.onSurfaceCreated(gl10, c52265Nv6 != null ? c52265Nv6.A01 : null);
                            }
                            z = false;
                        }
                        if (z5) {
                            AbstractTextureViewSurfaceTextureListenerC48676MOq abstractTextureViewSurfaceTextureListenerC48676MOq4 = (AbstractTextureViewSurfaceTextureListenerC48676MOq) weakReference.get();
                            if (abstractTextureViewSurfaceTextureListenerC48676MOq4 != null && (renderer2 = abstractTextureViewSurfaceTextureListenerC48676MOq4.A01) != null) {
                                renderer2.onSurfaceChanged(gl10, i, i2);
                            }
                            z5 = false;
                        }
                        AbstractTextureViewSurfaceTextureListenerC48676MOq abstractTextureViewSurfaceTextureListenerC48676MOq5 = (AbstractTextureViewSurfaceTextureListenerC48676MOq) weakReference.get();
                        if (gl10 != null && abstractTextureViewSurfaceTextureListenerC48676MOq5 != null && (renderer = abstractTextureViewSurfaceTextureListenerC48676MOq5.A01) != null) {
                            renderer.onDrawFrame(gl10);
                        }
                        C52265Nv3 c52265Nv7 = this.A0E;
                        if (c52265Nv7 != null) {
                            EGL10 egl17 = c52265Nv7.A00;
                            int iEglGetError = 12288;
                            if (egl17 != null && !egl17.eglSwapBuffers(c52265Nv7.A03, c52265Nv7.A04)) {
                ...
                synchronized (AbstractTextureViewSurfaceTextureListenerC48676MOq.A0A) {
                    A02();
                    A01();
                    throw th4;
                }
    ...
    private final void A01() {
        if (this.A07) {
            C52265Nv3 c52265Nv3 = this.A0E;
            if (c52265Nv3 != null) {
                EGLContext eGLContext = c52265Nv3.A02;
                if (eGLContext != null) {
                    AbstractTextureViewSurfaceTextureListenerC48676MOq abstractTextureViewSurfaceTextureListenerC48676MOq = (AbstractTextureViewSurfaceTextureListenerC48676MOq) c52265Nv3.A05.get();
                    if (abstractTextureViewSurfaceTextureListenerC48676MOq != null && abstractTextureViewSurfaceTextureListenerC48676MOq.A02 != null) {
                        EGL10 egl10 = c52265Nv3.A00;
                        EGLDisplay eGLDisplay = c52265Nv3.A03;
                        if (egl10 != null && !egl10.eglDestroyContext(eGLDisplay, eGLContext)) {
                            C52265Nv3.A07.A00("eglDestroyContext", egl10.eglGetError());
                            throw null;
                        }
                    }
                    c52265Nv3.A02 = null;
    ...
    public void run() {
        ...
        try {
            ...
            AbstractTextureViewSurfaceTextureListenerC48676MOq.A0A.A00(this);
        }
    }
}
