...
public final class FMN {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof FMN) {
                FMN fmn = (FMN) obj;
                if (!C000700h.areEqual(this.A01, fmn.A01) || !C000700h.areEqual(this.A00, fmn.A00)) {
                }
            }
            return false;
        }
    ...
    public String toString() {
        ...
        sbA08.append("CachedDataBundle(dataBundle=");
        sbA08.append(c1m1);
        return AbstractC32971bt.A0R(c29651Qb, ", asyncDataBundle=", sbA08);
    }

    public FMN(C29651Qb c29651Qb, C1M1 c1m1) {
        this.A01 = c1m1;
        this.A00 = c29651Qb;
    }
}
