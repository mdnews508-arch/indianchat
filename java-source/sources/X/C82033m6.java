...
import com.whatsapp.nativediscovery.common.repository.location.CountryProvider;
import java.util.Iterator;
import java.util.LinkedHashMap;
import java.util.Set;

/* JADX INFO: renamed from: X.3m6, reason: invalid class name and case insensitive filesystem */
/* JADX INFO: loaded from: classes4.dex */
public final class C82033m6 extends C0K3<Integer, CountryProvider> {
    @Override // X.C0K3
    public java.util.Map A00() {
        Set setA0z = AbstractC81763lf.A0z(7762);
        LinkedHashMap linkedHashMapA14 = AbstractC466425r.A14(AbstractC002201c.A00(setA0z));
        Iterator it = setA0z.iterator();
        while (it.hasNext()) {
            it.next();
            linkedHashMapA14.put(1, C00C.A02(49715));
        }
