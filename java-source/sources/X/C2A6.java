...
/* JADX INFO: renamed from: X.2A6, reason: invalid class name */
/* JADX INFO: loaded from: classes3.dex */
public final class C2A6 implements InterfaceC147376dV {
    ...
    public String B47(InterfaceC146426by interfaceC146426by) {
        ...
        int i = R.string._name_removed__res_0x7f120bc5;
        if (z) {
            i = R.string._name_removed__res_0x7f120bc6;
        }
    ...
    public boolean CTk(Collection collection) {
        ...
        return AbstractC466225p.A1a(AbstractC64012w0.A00((C13C) C05C.A02(this.A02), (C31911Dxa) AbstractC466825v.A0h(this.A01), collection), C02S.A0C);
    }
