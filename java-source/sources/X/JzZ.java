...
public final class JzZ extends AbstractC45231KHf {
    public final M95 A00;
    public final Long A01;
    public final List A02;

    public JzZ(M95 m95, Long l, List list) {
        C000700h.A0A(m95, 1);
        this.A02 = list;
        this.A00 = m95;
        this.A01 = l;
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof JzZ) {
                JzZ jzZ = (JzZ) obj;
                if (!C000700h.areEqual(this.A02, jzZ.A02) || !C000700h.areEqual(this.A00, jzZ.A00) || !C000700h.areEqual(this.A01, jzZ.A01)) {
                }
            }
            return false;
        }
