...
public final class C40738Hvv {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof C40738Hvv) {
                C40738Hvv c40738Hvv = (C40738Hvv) obj;
                if (!C000700h.areEqual(this.A02, c40738Hvv.A02) || !C000700h.areEqual(this.A03, c40738Hvv.A03) || !C000700h.areEqual(this.A01, c40738Hvv.A01) || !C000700h.areEqual(this.A00, c40738Hvv.A00)) {
                }
            }
            return false;
        }
    ...
    public String toString() {
        ...
        sbA08.append("CommonCertificate(encryptionCertificate=");
    ...
    public C40738Hvv(Integer num, PublicKey publicKey, X509Certificate x509Certificate, X509Certificate x509Certificate2) {
