...
public final class C46596Kwo {
    public static C46596Kwo A01;
    ...
    public static final boolean A00(PackageInfo packageInfo, boolean z) {
        ...
        int i = 0;
        while (!Arrays.equals(bArr[i], byteArray)) {
            i++;
            if (i >= length) {
                return false;
            }
    ...
    public final boolean A01() {
        ...
        try {
            packageInfo = C19730uE.A00(this.A00).A00.getPackageManager().getPackageInfo("com.google.android.wearable.app.cn", 64);
        } catch (PackageManager.NameNotFoundException unused) {
            packageInfo = null;
        }
        if (packageInfo != null) {
            if (!GooglePlayServicesUtil.A02(this.A00)) {
                if (!A00(packageInfo, false)) {
                    if (A00(packageInfo, true)) {
    ...
    public C46596Kwo(Context context) {
