...
public abstract class CNU {
    public static final C26131Bcy A00(EngineState engineState) {
        GeneratedMessageLite generatedMessageLiteA09;
        Object next;
        C26131Bcy c26131Bcy = C26131Bcy.DEFAULT_INSTANCE;
        C000700h.A06(c26131Bcy);
        ...
        do {
            ...
            next = itA14.next();
        } while (!C000700h.areEqual(((com.meta.wearable.comms.calling.hera.engine.base.Any) next).type_, "CodecAvatarState"));
        ...
        if (any != null) {
            ...
            if (obj == null) {
                generatedMessageLiteA09 = BA2.A09(lruCache, c26131Bcy, any, c28688ChpA02);
            } else if (obj instanceof C26131Bcy) {
        ...
        return (C26131Bcy) generatedMessageLiteA09;
    }
}
