...
public final class C41167IBa {
    ...
    public final void A06(List list, List list2) {
        ...
        try {
            c15tA05.A02.A04("status_crossposting_v3", A00(list.size(), list2.size()), "[WAFFLE] WaffleStatusCrosspostingStore/DELETE_CROSSPOSTING_COLUMN_BY_MESSAGE_AND_DESTINATION_IDS", AbstractC466625t.A1b(arrayListA0W, 0));
            c15tA05.close();
        } catch (Throwable th) {
            try {
                throw th;
    ...
    public static final String A00(int i, int i2) {
        ...
        sbA08.append("status_message_row_id IN  (");
        sbA08.append(strA10);
        return AbstractC32971bt.A0S(") AND destination IN (", strA11, sbA08);
    }

    public static final void A01(ContentValues contentValues, EnumC41171qt enumC41171qt, C41167IBa c41167IBa, List list) {
        C15T c15tA05 = c41167IBa.A01.A05();
        try {
    ...
    public static final void A02(ContentValues contentValues, C41167IBa c41167IBa, List list) {
        C15T c15tA05 = c41167IBa.A01.A05();
        try {
            C0JB c0jb = c15tA05.A02;
            String strA0S = AbstractC32971bt.A0S("status_message_row_id IN  (", GV5.A0W(list), AnonymousClass000.A08());
            ArrayList arrayListA0o = AbstractC466825v.A0o(list);
            Iterator it = list.iterator();
            while (it.hasNext()) {
                AbstractC467025x.A1C(arrayListA0o, it);
    ...
    public final HCA A03() {
        InterfaceC001500s interfaceC001500s = this.A00.A00;
        ((IAV) interfaceC001500s.get()).A02();
        return (HCA) interfaceC001500s.get();
    }
    ...
    public final void A04(String str, List list, int i, long j) {
        ...
        while (it.hasNext()) {
            ...
            C15T c15tA05 = this.A01.A05();
            try {
                c15tA05.A02.A09("status_crossposting_v3", "[WAFFLE] WaffleStatusCrosspostingStore/INSERT_CROSSPOSTING_RECORDS", contentValuesA06, 4);
                c15tA05.close();
            } catch (Throwable th) {
                try {
                    throw th;
    ...
    public final void A05(String str, List list, List list2) {
        ...
        while (it.hasNext()) {
            ...
            A01(contentValuesA06, enumC41171qt, this, list);
        }
    }
    ...
    public final void A07(List list, List list2, int i) {
        ...
        C15T c15tA05 = this.A01.A05();
        try {
            c15tA05.A02.A02(contentValuesA06, "status_crossposting_v3", A00(list.size(), list2.size()), "[WAFFLE] WaffleStatusCrosspostingStore/UPDATE_CROSSPOSTING_COLUMN_BY_MESSAGE_ROW_IDS", AbstractC466625t.A1b(arrayListA0W, 0));
            c15tA05.close();
        } catch (Throwable th) {
            try {
                throw th;
