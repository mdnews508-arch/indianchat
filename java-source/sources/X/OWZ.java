...
public final class OWZ implements PDY {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof OWZ) {
                OWZ owz = (OWZ) obj;
                if (!C000700h.areEqual(this.A00, owz.A00) || !C000700h.areEqual(this.A03, owz.A03) || !C000700h.areEqual(this.A04, owz.A04) || !C000700h.areEqual(this.A02, owz.A02) || !C000700h.areEqual(this.A01, owz.A01) || this.A05 != owz.A05) {
                }
            }
            return false;
        }
    ...
    public String toString() {
        ...
        sbA08.append("LinkMessage(messageModel=");
    ...
    public OWZ(C176767pw c176767pw, AbstractC28455Cd9 abstractC28455Cd9, List list, Function1 function1, Function1 function2, boolean z) {
        this.A00 = c176767pw;
        this.A03 = function1;
        this.A04 = function2;
        this.A02 = list;
