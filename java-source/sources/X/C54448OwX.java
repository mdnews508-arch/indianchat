...
public class C54448OwX extends AbstractC54424Ow9 {
    ...
    @Override // X.C1TZ
    public boolean A0H() {
        return this.A02 || AbstractC54424Ow9.A01(this).A0F().A0H();
    }

    @Override // X.C1TZ
    public int A0D() {
        int iA01;
        int iA0D = AbstractC54424Ow9.A01(this).A0F().A0D();
        if (this.A02) {
    ...
    public void A0G(O2T o2t, boolean z) throws IOException {
        C1TZ c1tzA0F = AbstractC54424Ow9.A01(this).A0F();
        boolean z2 = this.A02;
        o2t.A05(z, (z2 || c1tzA0F.A0H()) ? 160 : 128, this.A00);
        if (z2) {
            o2t.A03(c1tzA0F.A0D());
        }
