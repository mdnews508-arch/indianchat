...
import com.whatsapp.infra.graphapi.fb.FbGraphApiDomainResolver;
import java.util.Iterator;
import java.util.LinkedHashMap;
import java.util.Set;

/* JADX INFO: renamed from: X.4RT, reason: invalid class name */
/* JADX INFO: loaded from: classes4.dex */
public final class C4RT extends C0K3<Integer, FbGraphApiDomainResolver> {
    @Override // X.C0K3
    public java.util.Map A00() {
        Set setA0z = AbstractC81763lf.A0z(7549);
        LinkedHashMap linkedHashMapA14 = AbstractC466425r.A14(AbstractC002201c.A00(setA0z));
        Iterator it = setA0z.iterator();
        while (it.hasNext()) {
            it.next();
            linkedHashMapA14.put(AbstractC466025n.A1H(), C00S.A03(49283));
        }
