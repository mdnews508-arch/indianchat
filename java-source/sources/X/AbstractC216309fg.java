...
public abstract class AbstractC216309fg {
    public static final void A00(B7T b7t, final String str, final String str2, final String str3, final String str4, final Function0 function0, final Function0 function1, final int i) {
        ...
        if ((196608 & i) == 0) {
            iA0O |= AbstractC202218rq.A0U(b7t, function1);
        }
        if (AbstractC202168rl.A1X(b7t, iA0O, AbstractC202228rr.A1S(iA0O))) {
            ...
            A46.A01(b7t, AH8.A02(b7t, abstractC204758wE, fillElement), AbstractC202168rl.A0H(AHA.A01(b7t)), C23080AFn.A00(), C12T.WDS_FONT_HEADLINE2, null, AbstractC202228rr.A0Q(b7t).getString(R.string._name_removed__res_0x7f124d8a), null, 0, 0, 0, 384, 0, 2016, false);
            B7K b7kA08 = AH8.A08(b7t, abstractC204758wE, fillElement);
            ...
            A4B.A01(b7t, str, str2, str3, str4, AbstractC202208rp.A04(iA0O, iA0O & 14));
            AMH.A0S(amh, true);
            ...
            AFN.A03(b7t, fillElement, null, null, AbstractC202228rr.A0Q(b7t).getString(R.string._name_removed__res_0x7f124d89), null, function0, ((iA0O >> 9) & 112) | 384, 248, false, false);
            AbstractC23039ADl.A00(b7t, abstractC204758wE, an4);
            AFN.A03(b7t, fillElement, null, ADF.A00(), AbstractC202228rr.A0Q(b7t).getString(R.string._name_removed__res_0x7f124d87), null, function1, ((iA0O >> 12) & 112) | 384, 120, false, false);
            AbstractC23039ADl.A00(b7t, abstractC204758wE, an4);
            AMH.A0S(amh, true);
            AMH.A0S(amh, true);
        } else {
        ...
        if (amtANq != null) {
            amtANq.A06 = new InterfaceC020009l() { // from class: X.AiV
                ...
                public final Object invoke(Object obj, Object obj2) {
                    AbstractC216309fg.A00((B7T) obj, str, str2, str3, str4, function0, function1, AbstractC22785A2r.A00(i));
                    return C05S.A00;
                }
            };
        }
