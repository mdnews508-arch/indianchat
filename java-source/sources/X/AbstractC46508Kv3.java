...
/* JADX INFO: renamed from: X.Kv3, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes10.dex */
public abstract class AbstractC46508Kv3 {
    ...
    public static void A01(int i, int i2) {
        ...
        if (i < 0 || i >= i2) {
            ...
            throw J27.A0a(KMj.A00(str, objArrA1b));
        }
    }
    ...
    public static void A02(int i, int i2, int i3) {
        ...
        if (i < 0) {
            ...
            if (i > i3) {
                ...
                strA00 = KMj.A00("end index (%s) must not be less than start index (%s)", objArrA1a);
            }
        }
