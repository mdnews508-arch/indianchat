...
public final class C49729MrM extends AbstractC53424Ocq {
    public static final O92 A00 = MJm.A0f(C02S.A0C, C02S.A00, AbstractC466425r.A1B(C49729MrM.class), 25);
    public static final long serialVersionUID = 0;
    public final Long chat_db_migration_timestamp;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C49729MrM(Long l, C53446OdH c53446OdH) {
        super(A00, c53446OdH);
    ...
    public boolean equals(Object obj) {
        if (obj != this) {
            if (obj instanceof C49729MrM) {
                C49729MrM c49729MrM = (C49729MrM) obj;
                if (!AbstractC53424Ocq.A04(c49729MrM, this.A02) || !C000700h.areEqual(this.chat_db_migration_timestamp, c49729MrM.chat_db_migration_timestamp)) {
                }
            }
            return false;
        }
    ...
    public String toString() {
        ...
        return AbstractC53424Ocq.A03("LIDMigration{", arrayListA0W);
    }
