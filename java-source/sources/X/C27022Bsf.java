...
public final class C27022Bsf extends AbstractC37408GbA implements InterfaceC31574Drm {
    public final C0JC A00;
    public final C31910DxZ A01;
    public final TextView A02;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C27022Bsf(Context context, J0E j0e, C31910DxZ c31910DxZ, C1LT c1lt) {
        super(context, j0e, c1lt);
        AbstractC466225p.A1Q(context, 0, c31910DxZ);
        this.A01 = c31910DxZ;
    ...
    public void setFMessage(C1DO c1do) {
        C000700h.A0A(c1do, 0);
        C00K.A0B(c1do instanceof C0F);
        super.setFMessage(c1do);
    }

    private final void A00() {
        String strA1M = AbstractC466025n.A1M(getContext(), R.string._name_removed__res_0x7f12209b);
        ...
        UXLog.setOnClickListener(textView, D7Q.A00(this, 45), -241142128);
    }
    ...
    public C0F getFMessage() {
        C1DO fMessage = super.getFMessage();
        C000700h.A0D(fMessage, "null cannot be cast to non-null type com.whatsapp.infra.fmessage.systemmessage.protocol.message.FMessageSystemEphemeralKeepInChat");
        return (C0F) fMessage;
    }
}
