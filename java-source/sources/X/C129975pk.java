...
/* JADX INFO: renamed from: X.5pk, reason: invalid class name and case insensitive filesystem */
/* JADX INFO: loaded from: classes4.dex */
public final class C129975pk implements InterfaceC147306dO {
    public static final C129975pk A00 = new C129975pk();
    ...
    public C5I6 CaT(Integer num) {
        ...
        if (iA0G == 0) {
            ...
            num2 = C02S.A00;
            c129865pZA00 = C129865pZ.A00(1.2857f);
            f = null;
            f2 = 14.0f;
            f3 = -0.15f;
        } else {
