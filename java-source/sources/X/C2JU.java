...
/* JADX INFO: renamed from: X.2JU, reason: invalid class name */
/* JADX INFO: loaded from: classes3.dex */
public final class C2JU extends AbstractC236011x {
    ...
    public /* bridge */ /* synthetic */ C1JZ Bed(ViewGroup viewGroup, int i) {
        ...
        if (objA1D == null) {
            throw AbstractC465925m.A15(AnonymousClass000.A07("No footer view for viewType ", AnonymousClass000.A08(), i));
        }
        View view = (View) objA1D;
        AbstractC467025x.A0d(view);
        view.setLayoutParams(AbstractC466825v.A0I());
        return new C2KJ(view);
    }
