...
/* JADX INFO: renamed from: X.65Q, reason: invalid class name */
/* JADX INFO: loaded from: classes4.dex */
public final class C65Q implements InterfaceC147386dW {
    @Override // X.InterfaceC147386dW
    public String B6N(C016207r c016207r, Integer num) {
        C000700h.A0A(c016207r, 1);
        int iA0Y = c016207r.A0Y(15901);
        if (iA0Y == 1) {
            return "fb_links_xma_control_ni";
        }
        if (iA0Y != 2) {
            return null;
        }
        return "fb_links_xma_test_ni";
    }

    @Override // X.InterfaceC147386dW
    public boolean CTZ(C016207r c016207r) {
        C000700h.A0A(c016207r, 0);
        return AbstractC466225p.A1V(c016207r.A0Y(15901));
    }
