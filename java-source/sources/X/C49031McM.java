...
public final class C49031McM extends AbstractC16780p1 implements InterfaceC201558qm {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C49031McM(JSONObject jSONObject) {
        super(jSONObject);
        C000700h.A0A(jSONObject, 0);
    }

    @Override // X.InterfaceC201558qm
    public String Adq() {
