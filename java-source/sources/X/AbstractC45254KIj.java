...
public abstract class AbstractC45254KIj {
        ...
        if (this instanceof JVE) {
            ...
            if (i13 != length) {
                while (i13 < length) {
                            ...
                            if ((cCharAt4 < 55296 && 57343 >= cCharAt4) || j4 > j5 - 3) {
                                ...
                                if (i13 + 1 != length) {
                                    ...
                                    if (Character.isSurrogatePair(cCharAt4, cCharAt5)) {
                                        ...
                                        long j6 = j4 + 1;
                                        L3F.A06(bArr, j4, (byte) ((codePoint >>> 18) | 240));
                                        j = j6 + 1;
                                        i10 = 128;
                                        L3F.A06(bArr, j6, (byte) (((codePoint >>> 12) & 63) | 128));
                                        j2 = j + 1;
                                        i9 = (codePoint >>> 6) & 63;
                                        i11 = codePoint;
                                    }
                                }
                                throw new K7G(i13 - 1, length);
                            }
                            j = j4 + 1;
                            L3F.A06(bArr, j4, (byte) ((cCharAt4 >>> '\f') | 480));
                            j2 = j + 1;
                            i9 = (cCharAt4 >>> 6) & 63;
                            i10 = 128;
                            i11 = cCharAt4;
                            L3F.A06(bArr, j, (byte) (i9 | i10));
                            j3 = j2 + 1;
                            b = (byte) ((i11 & 63) | i10);
                        }
                        L3F.A06(bArr, j2, b);
                    ...
                    if (j4 <= j5 - 2) {
                        j2 = j4 + 1;
                        L3F.A06(bArr, j4, (byte) ((cCharAt4 >>> 6) | 960));
                        j3 = j2 + 1;
                        b = (byte) ((cCharAt4 & '?') | 128);
                    } else {
                        if (cCharAt4 < 55296) {
    ...
    public int A01(byte[] bArr, int i, int i2) {
                ...
                while (i7 < i2) {
                    ...
                    if (i10 < 0) {
                        if (i10 >= -32) {
                            ...
                            AbstractC45254KIj abstractC45254KIj = AbstractC46532KvW.A00;
                            i8 = bArr[i9 - 1];
                            int i15 = i2 - i9;
                            if (i15 != 0) {
                                if (i15 == 1) {
        ...
        if ((i | i2 | (length - i2)) < 0) {
            ...
            AbstractC466225p.A1K(i7, objArr);
            AbstractC466425r.A1U(objArr, i2, 2);
            throw J29.A0U("Array length=%d, index=%d, limit=%d", objArr);
        }
        long j = i7;
        int i19 = (int) (((long) i2) - j);
        if (i19 >= 16) {
            long j2 = j;
            i4 = 0;
            while (true) {
                long j3 = j2 + 1;
                if (L3F.A02.A01(bArr, L3F.A00 + j2) < 0) {
                    break;
                }
                i4++;
                j2 = j3;
        ...
        while (true) {
            ...
            while (true) {
                ...
                long j5 = j4 + 1;
                iA01 = L3F.A02.A01(bArr, L3F.A00 + j4);
                if (iA01 < 0) {
                    j4 = j5;
                    break;
                }
            ...
            if (iA01 >= -32) {
                if (iA01 >= -16) {
                    ...
                    long j7 = L3F.A00;
                    byte bA01 = abstractC46493Kud.A01(bArr, j7 + j4);
                    if (bA01 > -65 || J29.A03(iA01, bA01) != 0) {
                        return -1;
                    }
                    j4 = j6 + 1;
                    if (abstractC46493Kud.A01(bArr, j7 + j6) > -65) {
                        return -1;
                    }
                } else {
                    if (i5 < 2) {
                    ...
                    long j9 = L3F.A00;
                    byte bA02 = abstractC46493Kud2.A01(bArr, j9 + j4);
                    if (bA02 > -65) {
                        return -1;
                    }
                    if (iA01 == -32) {
                    ...
                    } else if (iA01 == -19 && bA02 >= -96) {
                        return -1;
                    }
                    j4 = j8 + 1;
                    if (abstractC46493Kud2.A01(bArr, j9 + j8) > -65) {
                        return -1;
                    }
                }
            } else {
            ...
            long j10 = j4 + 1;
            if (L3F.A02.A01(bArr, L3F.A00 + j4) > -65) {
                return -1;
            }
            j4 = j10;
        }
        if (i5 == 0) {
            AbstractC45254KIj abstractC45254KIj2 = AbstractC46532KvW.A00;
            if (iA01 > -12) {
                return -1;
            }
            return iA01;
        ...
        if (i5 == 1) {
            byte bA03 = L3F.A02.A01(bArr, L3F.A00 + j4);
            AbstractC45254KIj abstractC45254KIj3 = AbstractC46532KvW.A00;
            if (iA01 > -12 || bA03 > -65) {
                return -1;
            }
            i6 = bA03 << 8;
            ...
            long j11 = L3F.A00;
            byte bA04 = abstractC46493Kud3.A01(bArr, j11 + j4);
            byte bA05 = abstractC46493Kud3.A01(bArr, j11 + j4 + 1);
            AbstractC45254KIj abstractC45254KIj4 = AbstractC46532KvW.A00;
            if (iA01 > -12 || bA04 > -65 || bA05 > -65) {
                return -1;
            }
            iA01 ^= bA04 << 8;
            i6 = bA05 << 16;
