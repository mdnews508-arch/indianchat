...
public final class IZ1 implements InterfaceC04780Lp {
    public final C05C A01 = C05D.A00(131543);
    public final C05C A00 = AnonymousClass056.A00(131541);
    ...
    public void Bq2(C1DO c1do, int i) {
        C000700h.A0A(c1do, 0);
        if (-1 == i && ((C40318Hoo) C05C.A02(this.A00)).A00()) {
            Handler handler = (Handler) C05C.A02(this.A01);
            handler.sendMessage(handler.obtainMessage(2000, c1do));
        }
    }
    ...
    public void BqH(C1DO c1do, C1DO c1do2) {
        ...
        if (((C40318Hoo) C05C.A02(this.A00)).A00()) {
            Handler handler = (Handler) C05C.A02(this.A01);
            handler.sendMessage(handler.obtainMessage(2100, c1do2));
        }
    }
