...
public final class C135355yW implements InterfaceC148536fO {
    public final float A00;
    public final boolean A01;

    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof C135355yW) {
                C135355yW c135355yW = (C135355yW) obj;
                if (Float.compare(this.A00, c135355yW.A00) != 0 || this.A01 != c135355yW.A01) {
                }
            }
            return false;
        }
    ...
    public String toString() {
        ...
        sbA08.append("FixedHeightDialogConfig(heightFraction=");
        sbA08.append(f);
        return AbstractC32971bt.A0U(", supportUnderlay=", sbA08, z);
    }

    public C135355yW(float f, boolean z) {
        this.A00 = f;
        this.A01 = z;
    }
