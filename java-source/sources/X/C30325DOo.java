...
/* JADX INFO: renamed from: X.DOo, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes7.dex */
public final class C30325DOo implements InterfaceC31885DxA {
                ...
                if (cursorA0A.moveToNext()) {
                    ...
                    if (userJidA00 != null) {
                        ...
                        if (C0D0.A0b(userJidA01)) {
                            ...
                            if (userJidA01 == null) {
                                com.whatsapp.infra.logging.Log.w("ContactChangedNumberDatabase/fill/LID -> PN mapping unknown");
                            } else {
