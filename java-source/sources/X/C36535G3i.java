...
/* JADX INFO: renamed from: X.G3i, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes8.dex */
public final class C36535G3i implements InterfaceC37037GOa, GNN {
    public final C34792FXi A00;
    public final EnumC33935Ezg A01;
    public final F10 A02;
    public final List A03;
    public final InterfaceC001000l A04 = AbstractC000900k.A01(new C36736GBh(5));
    public static final C012205s A05 = AbstractC81763lf.A15("^.{2,100}$");
    public static final C012205s A07 = AbstractC81763lf.A15("^[2-9]\\d{7}$");
    public static final C012205s A06 = AbstractC81763lf.A15("^\\d{7}$");
    ...
    public C36535G3i() {
        ...
        fnhArr[1] = new FNH(enumC33935Ezg, F10.A0D);
        fnhArr[2] = new FNH(enumC33935Ezg, F10.A0C);
        this.A03 = AbstractC465925m.A1G(new FNH(EnumC33935Ezg.A03, f10), fnhArr, 3);
        this.A00 = C34792FXi.A00(AbstractC466025n.A1O(EnumC33803ExY.COPY_PASTE), 31868, FTV.A00("HKD"));
    }
    ...
    public EnumC33935Ezg AKZ(String str) {
        ...
        C000700h.A0A(str, 0);
        this.A04.getValue();
        Iterator<E> it = C34686FTa.A00.iterator();
        do {
            if (!it.hasNext()) {
                next = null;
                break;
    ...
    public C34572FOn ARA(Integer num) {
        ...
        if (iA0G == 0) {
            ...
            c34497FLpArr[0] = AbstractC34919Fb8.A01(EnumC33894Ez1.A04, new GBZ(this, 6), R.string._name_removed__res_0x7f124693, R.string._name_removed__res_0x7f124692, false);
            AbstractC34919Fb8.A04(this, c34497FLpArr, 17);
            c34497FLpArr[2] = AbstractC34919Fb8.A00(F10.A0K, null, R.string._name_removed__res_0x7f124691, R.string._name_removed__res_0x7f124691);
            listA00 = FXP.A00(c34497FLpArr, 6);
    ...
    public F28 CZJ(C34902Fap c34902Fap, String str) {
        ...
        int iA00 = C34902Fap.A00(c34902Fap, "HK", str, mapA1C);
        if (iA00 != zA1a) {
            str2 = "bank_account";
            if (iA00 != 0 && iA00 != 2) {
                throw AbstractC465925m.A1J();
    ...
    public InterfaceC37047GOk CdS(F10 f10) {
        InterfaceC37047GOk interfaceC37047GOkA00;
        int i;
        List listA1O;
        int iA0E = AbstractC81803lj.A0E(f10);
        if (iA0E != 3) {
            if (iA0E == 9) {
                interfaceC37047GOkA00 = new C36549G3w(GCG.A00(2), A06);
                i = R.string._name_removed__res_0x7f124680;
                listA1O = AbstractC466025n.A1O("7");
            } else {
                if (iA0E != 4) {
                    return null;
                }
                interfaceC37047GOkA00 = f10.A00();
                i = R.string._name_removed__res_0x7f12467f;
            }
            return F73.A00(interfaceC37047GOkA00, listA1O, i);
        }
        interfaceC37047GOkA00 = C36549G3w.A00("852", A07);
        i = R.string._name_removed__res_0x7f124687;
