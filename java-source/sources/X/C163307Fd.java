...
public final class C163307Fd extends C7TV {
    public final int A00;
    public final boolean A01;

    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof C163307Fd) {
                C163307Fd c163307Fd = (C163307Fd) obj;
                if (this.A00 != c163307Fd.A00 || this.A01 != c163307Fd.A01) {
                }
            }
            return false;
        }
    ...
    public String toString() {
        ...
        sbA08.append("CropMediaIconTapped(screen=");
        sbA08.append(i);
        return AbstractC32971bt.A0U(", isSendingToStatus=", sbA08, z);
    }

    public C163307Fd(int i, boolean z) {
        this.A00 = i;
        this.A01 = z;
    }
}
