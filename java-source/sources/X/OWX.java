...
public final class OWX implements PDY {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof OWX) {
                OWX owx = (OWX) obj;
                if (!C000700h.areEqual(this.A00, owx.A00) || !C000700h.areEqual(this.A03, owx.A03) || !C000700h.areEqual(this.A04, owx.A04) || !C000700h.areEqual(this.A02, owx.A02) || !C000700h.areEqual(this.A01, owx.A01) || this.A05 != owx.A05) {
                }
            }
            return false;
        }
    ...
    public String toString() {
        ...
        sbA08.append("DocumentMessage(messageModel=");
    ...
    public OWX(C176767pw c176767pw, AbstractC28455Cd9 abstractC28455Cd9, List list, Function1 function1, Function1 function2, boolean z) {
        this.A00 = c176767pw;
        this.A03 = function1;
        this.A04 = function2;
        this.A02 = list;
