...
/* JADX INFO: renamed from: X.1FQ, reason: invalid class name */
/* JADX INFO: loaded from: classes.dex */
public final class C1FQ extends AbstractC08680aZ implements Parcelable {
    public static final C1FR A01 = new C1FR();
    public static final Parcelable.Creator CREATOR = new C1FS();
    public final String A00;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1FQ(String str) throws C017908k {
        super(str);
        C000700h.A0A(str, 0);
        this.A00 = str;
