...
public final class C41568ISg implements InterfaceC43011Ivq {
    ...
    public void BBH(Uri uri, C0I6 c0i6) {
        ...
        if (i3p.A00(this.A01, optional, AbstractC466625t.A0w(this.A00), c0i6, "lists")) {
            optional.get();
            throw AbstractC465925m.A17("getLabelsActivity");
        }
    }
}
