...
public final class C40755HwC {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof C40755HwC) {
                C40755HwC c40755HwC = (C40755HwC) obj;
                if (!C000700h.areEqual(this.A02, c40755HwC.A02) || !C000700h.areEqual(this.A03, c40755HwC.A03) || !C000700h.areEqual(this.A01, c40755HwC.A01) || !C000700h.areEqual(this.A00, c40755HwC.A00)) {
                }
            }
            return false;
        }
    ...
    public String toString() {
        ...
        sbA08.append("CertificateData(encryptionCert=");
    ...
    public C40755HwC(Integer num, PublicKey publicKey, X509Certificate x509Certificate, X509Certificate x509Certificate2) {
