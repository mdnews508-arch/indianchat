...
public final class C23665AbJ implements B6m {
    ...
    public View B76(View view) {
        C000700h.A0A(view, 0);
        return view.findViewById(R.id.settings_early_access_program_inflated);
    }
    ...
    @Override // X.B6m
    public String Ate() {
        return AbstractC466025n.A1M(this.A01, R.string._name_removed__res_0x7f1214d3);
    }

    @Override // X.B6m
    public boolean BOL() {
        return !this.A03.BJQ() && this.A02.A0w(22039);
    }
