...
/* JADX INFO: renamed from: X.65S, reason: invalid class name */
/* JADX INFO: loaded from: classes4.dex */
public final class C65S implements InterfaceC147386dW {
    @Override // X.InterfaceC147386dW
    public Integer Afj(C016207r c016207r) {
        C000700h.A0A(c016207r, 0);
        return c016207r.A0w(14724) ? C02S.A01 : C02S.A0C;
    }
    ...
    public String B6N(C016207r c016207r, Integer num) {
        ...
        if (iA0G == 2) {
            return "ig_links_cta_preloads";
        }
        if (iA0G == 1) {
            return "ig_links_cta_web";
        }
        if (iA0G != 0) {
            return null;
        }
        return "ig_links_cta_test_ni";
    }
