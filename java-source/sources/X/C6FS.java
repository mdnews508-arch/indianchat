...
/* JADX INFO: renamed from: X.6FS, reason: invalid class name */
/* JADX INFO: loaded from: classes4.dex */
public final class C6FS implements InterfaceC146996ct {
    @Override // X.InterfaceC146996ct
    public Integer AWn(InterfaceC147356dT interfaceC147356dT) {
        C000700h.A0A(interfaceC147356dT, 0);
        return AbstractC81803lj.A0m(interfaceC147356dT instanceof C6GE ? 1 : 0);
    }
    ...
    public C124825hF AQY(C124325gM c124325gM) {
        ...
        if ((abstractC100414gNA00 instanceof C6WZ) && (c6wz = (C6WZ) abstractC100414gNA00) != null) {
            ...
            if (AbstractC81803lj.A0C(c900244n) == 415909587) {
                return C124825hF.A03(new C6GE(new C42O(c900244n.A00).A0C("text")));
            }
        }
        return null;
    }
    ...
    public AbstractC100404gM CaE(C5R8 c5r8) {
        return AbstractC81823ll.A0d(c5r8, C124825hF.A02(c5r8) instanceof C6GE ? 1 : 0);
    }
}
