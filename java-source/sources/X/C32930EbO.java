...
public final class C32930EbO extends DIA {
    ...
    public /* bridge */ /* synthetic */ void A02(InterfaceC16790p2 interfaceC16790p2) {
        InterfaceC37074GPm interfaceC37074GPm = (InterfaceC37074GPm) interfaceC16790p2;
        C000700h.A0A(interfaceC37074GPm, 0);
        if (super.A01) {
            return;
        }
        InterfaceC37073GPl interfaceC37073GPlB9L = interfaceC37074GPm.B9L();
        boolean zA00 = AbstractC34088F5d.A00(interfaceC37073GPlB9L != null ? interfaceC37073GPlB9L.ABB() : null);
        ...
        if (zA00) {
            ...
            AbstractC31897DxM.A1K(interfaceC36989GMe, "Transfer ownership failed", 0);
        }
    }

    public C32930EbO(C28971Nl c28971Nl, UserJid userJid, InterfaceC36989GMe interfaceC36989GMe) {
    ...
    public InterfaceC16810p4 A00() {
        ...
        return new C16830p6(c16740oxA0G, ED8.class, TreeWithGraphQL.class, "NewsletterChangeOwner", "whatsapp-android-mex", GGO.A00, true);
    }
