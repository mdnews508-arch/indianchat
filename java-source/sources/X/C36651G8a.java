...
/* JADX INFO: renamed from: X.G8a, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes8.dex */
public final class C36651G8a implements GMP {
    public final C34934FbO A00;
    public final AnonymousClass089 A01;

    public C36651G8a(AnonymousClass089 anonymousClass089, C34934FbO c34934FbO) {
    ...
    /* JADX WARN: Code duplicated, block: B:48:0x00d1 A[ORIG_RETURN, RETURN] */
    /* JADX WARN: Code duplicated, block: B:51:0x00d6 A[ORIG_RETURN, RETURN] */
                                ...
                                switch (strA0f2.hashCode()) {
                                    case -1806407742:
                                        if (strA0f2.equals("SECONDS_SINCE_LESS_THAN")) {
                                            i2 = ((System.currentTimeMillis() - this.A00.A04(enumC33918EzP, str)) > (j * 1000) ? 1 : ((System.currentTimeMillis() - this.A00.A04(enumC33918EzP, str)) == (j * 1000) ? 0 : -1));
                                            if (i2 <= 0) {
                                                return true;
                                            }
                                            return false;
                                    ...
                                    case -526668609:
                                        if (strA0f2.equals("COUNT_AT_MOST")) {
                                            i2 = (this.A00.A03(enumC33918EzP, str) > j ? 1 : (this.A00.A03(enumC33918EzP, str) == j ? 0 : -1));
                                            if (i2 <= 0) {
                                                return true;
                                            }
                                            return false;
                                    ...
                                    case 851903629:
                                        if (strA0f2.equals("COUNT_AT_LEAST")) {
                                            i = (this.A00.A03(enumC33918EzP, str) > j ? 1 : (this.A00.A03(enumC33918EzP, str) == j ? 0 : -1));
                                            if (i >= 0) {
                                                return true;
                                            }
                                            return false;
                                    ...
                                    case 1832379851:
                                        if (strA0f2.equals("SECONDS_SINCE_GREATER_THAN")) {
                                            i = ((System.currentTimeMillis() - this.A00.A04(enumC33918EzP, str)) > (j * 1000) ? 1 : ((System.currentTimeMillis() - this.A00.A04(enumC33918EzP, str)) == (j * 1000) ? 0 : -1));
                                            if (i >= 0) {
                                                return true;
                                            }
                                            return false;
