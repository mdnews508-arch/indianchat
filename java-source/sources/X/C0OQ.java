...
/* JADX INFO: renamed from: X.0OQ, reason: invalid class name */
/* JADX INFO: loaded from: classes.dex */
public abstract class C0OQ implements Window.Callback {
    ...
    public ActionMode onWindowStartingActionMode(ActionMode.Callback callback, int i) {
        return A00(callback, this.A00, i);
    }

    public C0OQ(Window.Callback callback) {
        if (callback == null) {
    ...
    public boolean onSearchRequested(SearchEvent searchEvent) {
        return A01(searchEvent, this.A00);
    }
}
