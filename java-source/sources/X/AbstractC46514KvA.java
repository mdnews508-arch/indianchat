...
public abstract class AbstractC46514KvA {
    public static String A00(int i, int i2, String str) {
        ...
        if (i < 0) {
            ...
            if (i2 < 0) {
                throw AbstractC81763lf.A0m("negative size: ", J27.A0k(J29.A02(i2) + 15), i2);
            }
            objArrA1b = J28.A1b(str);
            AbstractC148906gC.A1H(objArrA1b, i, 1, i2, 2);
            str2 = "%s (%s) must not be greater than size (%s)";
        }
        return AbstractC46044KlI.A01(str2, objArrA1b);
    }
    ...
    public static void A01(int i, int i2) {
        ...
        if (i < 0 || i >= i2) {
            ...
            throw J27.A0a(AbstractC46044KlI.A01(str, objArrA1b));
        }
    }
    ...
    public static void A02(int i, int i2, int i3) {
        ...
        if (i < 0) {
            ...
            if (i > i3) {
                ...
                strA00 = AbstractC46044KlI.A01("end index (%s) must not be less than start index (%s)", objArrA1a);
            }
        }
