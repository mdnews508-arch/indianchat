...
public final class C27080Btb extends C0BP {
    public Integer A00;
    public String A01;

    public C27080Btb() {
        super(4548, new C001800w(1, 20, 200, false), 0, -1);
    }
    ...
    public java.util.Map getFieldsMapForFalco() {
        ...
        if (num != null && num.intValue() != 0) {
            linkedHashMapA1E.put("push_surface_id", num);
        }
        return linkedHashMapA1E;
    }
    ...
    public String toString() {
        ...
        sbA08.append("WamPushShow {");
        C0BR.A00(this.A01, "psaCampaignId", sbA08);
        return AbstractC32971bt.A0Q(AbstractC32971bt.A0P(this.A00), "pushSurfaceId", sbA08);
    }
}
