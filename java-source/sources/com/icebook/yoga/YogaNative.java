...
public final class YogaNative {
    ...
    public static final native float jni_YGNodeGetMinContentHeightJNI(long j);

    public static final native float jni_YGNodeGetMinContentWidthJNI(long j);
    ...
    public static final native void jni_YGNodeSetHasMinContentMeasureFuncJNI(long j, boolean z);

    public static final native void jni_YGNodeSetIsReferenceBaselineJNI(long j, boolean z);

    public static final native void jni_YGNodeSetMinContentHeightJNI(long j, float f);

    public static final native void jni_YGNodeSetMinContentWidthJNI(long j, float f);
