...
public final class StringValue extends GeneratedMessageLite implements StringValueOrBuilder {
    ...
    public final class Builder extends GeneratedMessageLite.Builder implements StringValueOrBuilder {
        ...
        public Builder clearValue() {
            ((StringValue) AbstractC466425r.A0I(this)).clearValue();
            return this;
        }

        public Builder setValue(String str) {
            ((StringValue) AbstractC466425r.A0I(this)).setValue(str);
            return this;
        }

        public Builder setValueBytes(ByteString byteString) {
            ((StringValue) AbstractC466425r.A0I(this)).setValueBytes(byteString);
            return this;
        }
    ...
    public static Builder newBuilder(StringValue stringValue) {
        return (Builder) J28.A0U(DEFAULT_INSTANCE, stringValue);
    }
    ...
    public static StringValue of(String str) {
        ...
        builderNewBuilder.setValue(str);
        return (StringValue) builderNewBuilder.build();
    }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (methodToInvoke) {
            ...
            case BUILD_MESSAGE_INFO:
                return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0001\u0000\u0000\u0001\u0001\u0001\u0000\u0000\u0000\u0001Ȉ", J29.A1b(1));
    ...
    public static StringValue parseFrom(ByteBuffer byteBuffer) {
        return (StringValue) J29.A0M(DEFAULT_INSTANCE, byteBuffer);
    }
