...
public final class NioByteString extends ByteString.LeafByteString {
    ...
    public boolean equals(Object obj) {
        ...
        ByteBuffer byteBufferAsReadOnlyByteBuffer;
        if (obj != this) {
                ...
                if (this.buffer.remaining() == byteString.size()) {
                    if (this.buffer.remaining() != 0) {
                        if (obj instanceof NioByteString) {
                            ...
                            byteBufferAsReadOnlyByteBuffer = ((NioByteString) obj).buffer;
                        } else {
                            if (obj instanceof RopeByteString) {
                                return obj.equals(this);
                            }
                            byteBuffer = this.buffer;
                            byteBufferAsReadOnlyByteBuffer = byteString.asReadOnlyByteBuffer();
                        }
                        return byteBuffer.equals(byteBufferAsReadOnlyByteBuffer);
                    }
                }
            }
            return false;
    ...
    private ByteBuffer slice(int i, int i2) {
        if (i < this.buffer.position() || i2 > this.buffer.limit() || i > i2) {
            ...
            throw J27.A0Y("Invalid indices [%d, %d]", objArrA1a);
        }
    ...
    public String toStringInternal(Charset charset) {
        ...
        return J27.A0i(charset, byteArray, iArrayOffset, length);
    }
