...
public final class Duration extends GeneratedMessageLite implements DurationOrBuilder {
    ...
    public final class Builder extends GeneratedMessageLite.Builder implements DurationOrBuilder {
        ...
        public Builder clearNanos() {
            Duration duration = (Duration) AbstractC466425r.A0I(this);
            int i = Duration.NANOS_FIELD_NUMBER;
            duration.nanos_ = 0;
            return this;
        }
        ...
        public Builder setNanos(int i) {
            Duration duration = (Duration) AbstractC466425r.A0I(this);
            int i2 = Duration.NANOS_FIELD_NUMBER;
            duration.nanos_ = i;
            return this;
        }
    ...
    public static Builder newBuilder(Duration duration) {
        return (Builder) J28.A0U(DEFAULT_INSTANCE, duration);
    }
    ...
    public static Duration parseFrom(ByteBuffer byteBuffer) {
        return (Duration) J29.A0M(DEFAULT_INSTANCE, byteBuffer);
    }
