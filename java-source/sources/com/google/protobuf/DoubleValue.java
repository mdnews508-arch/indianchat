...
public final class DoubleValue extends GeneratedMessageLite implements DoubleValueOrBuilder {
    ...
    public final class Builder extends GeneratedMessageLite.Builder implements DoubleValueOrBuilder {
        ...
        public Builder clearValue() {
            DoubleValue doubleValue = (DoubleValue) AbstractC466425r.A0I(this);
            int i = DoubleValue.VALUE_FIELD_NUMBER;
    ...
    public static Builder newBuilder(DoubleValue doubleValue) {
        return (Builder) J28.A0U(DEFAULT_INSTANCE, doubleValue);
    }
    ...
    public static DoubleValue of(double d) {
        ...
        builderNewBuilder.setValue(d);
        return (DoubleValue) builderNewBuilder.build();
    }
    ...
    public static DoubleValue parseFrom(ByteBuffer byteBuffer) {
        return (DoubleValue) J29.A0M(DEFAULT_INSTANCE, byteBuffer);
    }
