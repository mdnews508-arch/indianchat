...
public final class Int32Value extends GeneratedMessageLite implements Int32ValueOrBuilder {
    ...
    public final class Builder extends GeneratedMessageLite.Builder implements Int32ValueOrBuilder {
        ...
        public Builder clearValue() {
            Int32Value int32Value = (Int32Value) AbstractC466425r.A0I(this);
            int i = Int32Value.VALUE_FIELD_NUMBER;
            int32Value.value_ = 0;
            return this;
        }
        ...
        public Builder setValue(int i) {
            Int32Value int32Value = (Int32Value) AbstractC466425r.A0I(this);
            int i2 = Int32Value.VALUE_FIELD_NUMBER;
            int32Value.value_ = i;
            return this;
        }
    ...
    public static Builder newBuilder(Int32Value int32Value) {
        return (Builder) J28.A0U(DEFAULT_INSTANCE, int32Value);
    }
    ...
    public static Int32Value of(int i) {
        ...
        return (Int32Value) builderNewBuilder.build();
    }
    ...
    public static Int32Value parseFrom(ByteBuffer byteBuffer) {
        return (Int32Value) J29.A0M(DEFAULT_INSTANCE, byteBuffer);
    }
