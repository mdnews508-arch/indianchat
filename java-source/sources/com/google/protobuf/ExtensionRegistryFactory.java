...
public final class ExtensionRegistryFactory {
    ...
    public static ExtensionRegistryLite create() {
        ...
        return extensionRegistryLiteInvokeSubclassFactory == null ? new ExtensionRegistryLite() : extensionRegistryLiteInvokeSubclassFactory;
    }

    public static ExtensionRegistryLite createEmpty() {
        ExtensionRegistryLite extensionRegistryLiteInvokeSubclassFactory = invokeSubclassFactory("getEmptyRegistry");
        return extensionRegistryLiteInvokeSubclassFactory == null ? ExtensionRegistryLite.EMPTY_REGISTRY_LITE : extensionRegistryLiteInvokeSubclassFactory;
    }

    public static final ExtensionRegistryLite invokeSubclassFactory(String str) {
