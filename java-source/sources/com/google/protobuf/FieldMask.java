...
public final class FieldMask extends GeneratedMessageLite implements FieldMaskOrBuilder {
    ...
    public Internal.ProtobufList paths_ = ProtobufArrayList.EMPTY_LIST;

    public final class Builder extends GeneratedMessageLite.Builder implements FieldMaskOrBuilder {
        ...
        public Builder addAllPaths(Iterable iterable) {
            ((FieldMask) AbstractC466425r.A0I(this)).addAllPaths(iterable);
            return this;
        }

        public Builder addPaths(String str) {
            ((FieldMask) AbstractC466425r.A0I(this)).addPaths(str);
            return this;
        }

        public Builder addPathsBytes(ByteString byteString) {
            ((FieldMask) AbstractC466425r.A0I(this)).addPathsBytes(byteString);
            return this;
        }

        public Builder clearPaths() {
            ((FieldMask) AbstractC466425r.A0I(this)).clearPaths();
            return this;
        }

        public Builder setPaths(int i, String str) {
            ((FieldMask) AbstractC466425r.A0I(this)).setPaths(i, str);
            return this;
        }
    ...
    public void clearPaths() {
        this.paths_ = ProtobufArrayList.EMPTY_LIST;
    }
    ...
    public static Builder newBuilder(FieldMask fieldMask) {
        return (Builder) J28.A0U(DEFAULT_INSTANCE, fieldMask);
    }
    ...
    @Override // com.google.protobuf.FieldMaskOrBuilder
    public String getPaths(int i) {
        return AbstractC81773lg.A12(this.paths_, i);
    }

    @Override // com.google.protobuf.FieldMaskOrBuilder
    public ByteString getPathsBytes(int i) {
        return ByteString.copyFromUtf8(AbstractC81773lg.A12(this.paths_, i));
    }
    ...
    public void addAllPaths(Iterable iterable) {
        ...
        AbstractMessageLite.Builder.addAll(iterable, (List) this.paths_);
    }
    ...
    public static FieldMask parseFrom(ByteBuffer byteBuffer) {
        return (FieldMask) J29.A0M(DEFAULT_INSTANCE, byteBuffer);
    }
