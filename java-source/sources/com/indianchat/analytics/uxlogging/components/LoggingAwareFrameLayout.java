...
public class LoggingAwareFrameLayout extends FrameLayout implements P7Q {
    ...
    public LoggingAwareFrameLayout(Context context, AttributeSet attributeSet, int i) {
    ...
    public LoggingAwareFrameLayout(Context context) {
        this(context, null, 0);
        C000700h.A0A(context, 0);
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public LoggingAwareFrameLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
        C000700h.A0A(context, 0);
    }

    public /* synthetic */ LoggingAwareFrameLayout(Context context, AttributeSet attributeSet, int i, int i2, AbstractC63252uj abstractC63252uj) {
