...
public class WtCachedPsk implements Serializable {
    ...
    public WtCachedPsk(String str, byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte b, long j) {
        ...
        this.ticketAgeAdd = AbstractC52648O8f.A03(bArr2);
        long jA03 = AbstractC52648O8f.A03(bArr3);
        this.ticketLifetime = (jA03 > 172800 ? 172800L : jA03) * 1000;
        this.ticket = bArr4;
