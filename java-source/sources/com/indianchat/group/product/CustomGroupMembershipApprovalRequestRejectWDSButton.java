...
public final class CustomGroupMembershipApprovalRequestRejectWDSButton extends WDSButton {
    ...
    public void setupBackgroundStyle(ColorStateList colorStateList, ColorStateList colorStateList2) {
        ...
        ColorStateList colorStateListA03 = C04Y.A03(getContext(), R.color._name_removed__res_0x7f0602eb);
    ...
    public void setupContentStyle(ColorStateList colorStateList) {
        C000700h.A0A(colorStateList, 0);
        ColorStateList colorStateListA03 = C04Y.A03(getContext(), R.color._name_removed__res_0x7f0602ec);
        if (colorStateListA03 != null) {
            colorStateList = colorStateListA03;
        }
    ...
    public /* synthetic */ CustomGroupMembershipApprovalRequestRejectWDSButton(Context context, AttributeSet attributeSet, int i, AbstractC63252uj abstractC63252uj) {
