...
@Serializable
public final class OrbitVideosResponse {
    ...
    static {
        ...
        AbstractC81773lg.A1Q(C53700Ohn.A00(C02S.A01, 33), null, interfaceC001000lArr, 1);
        A03 = interfaceC001000lArr;
    }

    public OrbitVideosResponse(InterfaceC54779P9l interfaceC54779P9l, Long l, List list) {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof OrbitVideosResponse) {
                OrbitVideosResponse orbitVideosResponse = (OrbitVideosResponse) obj;
                if (!C000700h.areEqual(this.A00, orbitVideosResponse.A00) || !C000700h.areEqual(this.A02, orbitVideosResponse.A02) || !C000700h.areEqual(this.A01, orbitVideosResponse.A01)) {
                }
            }
            return false;
        }
    ...
    public String toString() {
        ...
        sbA08.append("OrbitVideosResponse(status=");
    ...
    public /* synthetic */ OrbitVideosResponse(InterfaceC54779P9l interfaceC54779P9l, Long l, List list, int i) {
