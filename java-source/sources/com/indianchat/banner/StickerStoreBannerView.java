...
public final class StickerStoreBannerView extends FrameLayout {
    ...
    private final AnonymousClass106 getStickerStoreQpManager() {
        return (AnonymousClass106) C05C.A02(this.A02);
    }
    ...
    /* JADX WARN: Type inference failed for: r0v6, types: [X.6yG] */
    public StickerStoreBannerView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        C000700h.A0A(context, 0);
        this.A02 = C05D.A00(5683);
        this.A03 = AbstractC466025n.A0G();
        this.A00 = AbstractC466025n.A0F();
        final AnonymousClass106 stickerStoreQpManager = getStickerStoreQpManager();
        final InterfaceC016307s waWorkers = getWaWorkers();
        final C016207r c016207rA0e = AbstractC148856g7.A0e(this.A00);
        this.A01 = new AbstractC35653Fn5(this, stickerStoreQpManager, c016207rA0e, waWorkers) { // from class: X.6yG
            public final FrameLayout A00;
            public final boolean A01;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(this, stickerStoreQpManager, c016207rA0e, waWorkers);
                AbstractC466325q.A18(stickerStoreQpManager, waWorkers, c016207rA0e, 0);
                this.A00 = this;
    ...
    public /* synthetic */ StickerStoreBannerView(Context context, AttributeSet attributeSet, int i, int i2, AbstractC63252uj abstractC63252uj) {
