...
public final class GetNewsletterStatusResponsesJob extends BaseNewslettersJob {
    ...
    public final long questionStatusServerId;
    ...
    public GetNewsletterStatusResponsesJob(C28971Nl c28971Nl, InterfaceC31753Dun interfaceC31753Dun, EnumC33830Exz enumC33830Exz, String str, int i, long j) {
        boolean z;
        super("GetNewsletterStatusResponsesJob");
        this.newsletterJid = c28971Nl;
        this.questionStatusServerId = j;
        this.count = i;
    ...
    @Override // org.whispersystems.jobqueue.Job
    public void A0E() {
        Log.i("GetNewsletterStatusResponsesJob/onAdded");
    }

    @Override // org.whispersystems.jobqueue.Job
    public void A0F() {
        Log.i("GetNewsletterStatusResponsesJob/onCanceled");
    }

    @Override // org.whispersystems.jobqueue.Job
    public void A0G() {
        C28971Nl c28971Nl = this.newsletterJid;
        long j = this.questionStatusServerId;
        int i = this.count;
        String str = this.beforeResponseServerId;
        StringBuilder sbA08 = AnonymousClass000.A08();
        sbA08.append("GetNewsletterStatusResponsesJob/onRun newsletterJid=");
        ...
        long j2 = this.questionStatusServerId;
        if (99 > j2 || j2 >= 2147476648) {
            AbstractC466225p.A0j(c05cA0a).A0g("GetNewsletterStatusResponsesJob/invalid params - questionStatusServerId", null, false, 1);
            return;
        }
        String strA0u = BA0.A0u(this.messageClient$delegate.A00);
        C28971Nl c28971Nl2 = this.newsletterJid;
        long j3 = this.questionStatusServerId;
        long j4 = this.count;
        String str2 = this.beforeResponseServerId;
        C27584C4z c27584C4z = null;
        ...
        C5X c5x = new C5X(c28971Nl2, c27584C4z2, c27584C4z, strA0u, j3, j4);
        ((C08750ag) C05C.A02(this.messageClient$delegate)).A0O(new C5S(c5x, new C28161CVb(this)), (C08940az) c5x.A00, strA0u, 480, 32000L);
    }
}
