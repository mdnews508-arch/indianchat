...
public class WDSRoundedFrameLayout extends FrameLayout implements InterfaceC43151Iy9 {
    public Path A00;
    public HSX A01;
    public boolean A02;
    ...
    public void setRoundedCornerType(HSX hsx) {
        C000700h.A0A(hsx, 0);
        boolean zEquals = hsx.equals(this.A01);
        this.A01 = hsx;
        if (zEquals) {
            return;
        }
        this.A02 = getRoundingDelegate().A05();
    }

    private final C41185ICb getRoundingDelegate() {
    ...
    public WDSRoundedFrameLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        C000700h.A0A(context, 0);
        this.A03 = C42282Iiu.A02(C02S.A0C, this, 32);
        this.A02 = true;
        this.A01 = new C37349GaC(EnumC37320GZj.A04, null, true);
    }

    public /* synthetic */ WDSRoundedFrameLayout(Context context, AttributeSet attributeSet, int i, int i2, AbstractC63252uj abstractC63252uj) {
        this(context, AbstractC466125o.A09(attributeSet, i2), AbstractC466125o.A00(i2, i));
    }

    public /* synthetic */ WDSRoundedFrameLayout(Context context, AttributeSet attributeSet, int i, AbstractC63252uj abstractC63252uj) {
