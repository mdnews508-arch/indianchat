...
public final class DeleteAccountExplainerFragment extends Fragment {
    ...
    public void A2C(Bundle bundle, View view) {
        ...
        if (wDSTextLayout != null) {
            ...
            wDSTextLayout.post(new C6C8(this, wDSTextLayout, 32));
            wDSTextLayout.setPrimaryButtonClickListener(ViewOnClickListenerC127775mA.A00(this, 30));
            wDSTextLayout.post(new C6C8(this, wDSTextLayout, 30));
            wDSTextLayout.setSecondaryButtonClickListener(ViewOnClickListenerC127775mA.A00(this, 31));
