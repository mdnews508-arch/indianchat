...
public final class GetStatusAudienceStringsOperation extends LinkedOperation {
    public static final HV7 Companion = new HV7();
    public final int version;

    public static final /* synthetic */ void write$Self$java_com_whatsapp_accountlinking_ipc_api_api(GetStatusAudienceStringsOperation getStatusAudienceStringsOperation, AnonymousClass259 anonymousClass259, InterfaceC36521j4 interfaceC36521j4) {
        if (anonymousClass259.CT5() || getStatusAudienceStringsOperation.version != 1) {
            anonymousClass259.ANS(interfaceC36521j4, 0, getStatusAudienceStringsOperation.version);
        }
    }
    ...
    public String toString() {
        return AbstractC32971bt.A0T("GetStatusAudienceStringsOperation(version=", AnonymousClass000.A08(), this.version);
    }

    public /* synthetic */ GetStatusAudienceStringsOperation(int i, int i2, HSZ hsz) {
        if ((i & 1) == 0) {
            this.version = 1;
        } else {
            this.version = i2;
    ...
    public /* synthetic */ GetStatusAudienceStringsOperation(int i, int i2, AbstractC63252uj abstractC63252uj) {
        this((i2 & 1) != 0 ? 1 : i);
    }
