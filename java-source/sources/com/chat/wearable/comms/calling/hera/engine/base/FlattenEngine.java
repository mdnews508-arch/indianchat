...
public abstract class FlattenEngine {
    ...
    public final class CppProxy extends FlattenEngine {
        ...
        private native void native_appendPostProcessor(long j, PostProcessor postProcessor);

        private native void native_eraseEngine(long j, Engine engine);

        private native void native_erasePostProcessor(long j, PostProcessor postProcessor);
        ...
        @Override // com.meta.wearable.comms.calling.hera.engine.base.FlattenEngine
        public void appendPostProcessor(PostProcessor postProcessor) {
            native_appendPostProcessor(this.nativeRef, postProcessor);
        }

        @Override // com.meta.wearable.comms.calling.hera.engine.base.FlattenEngine
        public void eraseEngine(Engine engine) {
            native_eraseEngine(this.nativeRef, engine);
        }

        @Override // com.meta.wearable.comms.calling.hera.engine.base.FlattenEngine
        public void erasePostProcessor(PostProcessor postProcessor) {
            native_erasePostProcessor(this.nativeRef, postProcessor);
        }
    ...
    public abstract void appendPostProcessor(PostProcessor postProcessor);

    public abstract void eraseEngine(Engine engine);

    public abstract void erasePostProcessor(PostProcessor postProcessor);
