...
public abstract class AbstractWindowedCursor extends AbstractCursor {
    ...
    public boolean hasWindow() {
        return AbstractC32971bt.A0t(this.mWindow);
    }

    @Override // io.requery.android.database.AbstractCursor, android.database.Cursor
    public boolean isNull(int i) {
        return AbstractC466725u.A1O(this.mWindow.getType(this.mPos, i));
    }
    ...
    public float getFloat(int i) {
        checkPosition();
        return (float) this.mWindow.getDouble(this.mPos, i);
    }

    @Override // io.requery.android.database.AbstractCursor, android.database.Cursor
    public int getInt(int i) {
        checkPosition();
        return (int) this.mWindow.getLong(this.mPos, i);
    }
    ...
    public short getShort(int i) {
        checkPosition();
        return (short) this.mWindow.getLong(this.mPos, i);
    }
